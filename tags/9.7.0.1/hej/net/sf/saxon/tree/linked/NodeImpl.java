...
public abstract class NodeImpl
        implements MutableNodeInfo, FingerprintedNode, SteppingNode<NodeImpl>, SiblingCountingNode, SourceLocator {
    ...
    public int getNameCode() {
        ...
        if (name == null) {
            ...
            return name.getNameCode();
        } else {
            return name.allocateNameCode(getConfiguration().getNamePool());
        }
    }
    ...
    public int getFingerprint() {
        ...
        if (name == null) {
            ...
            return name.getNameCode() & NamePool.FP_MASK;
        } else {
            return name.allocateNameCode(getConfiguration().getNamePool()) & NamePool.FP_MASK;
        }
    }
