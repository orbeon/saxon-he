...
public abstract class AtomicValue extends Value<AtomicValue>
    ...
    /*@NotNull*/ public final SequenceIterator<AtomicValue> iterate() {
    ...
    /*@NotNull*/ public final SequenceIterator<AtomicValue> getTypedValue() {
        return SingletonIterator.makeIterator(this);
    }
