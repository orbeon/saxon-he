...
public class Base64BinaryValue extends AtomicValue {
    ...
    public Base64BinaryValue(/*@NotNull*/ CharSequence s, AtomicType type) {
        Base64Decoder decoder = new Base64Decoder();
        decoder.translate(s);
        binaryValue = decoder.getByteArray();
        typeLabel = type;
...
*                sensitive @return an Object whose equals() and hashCode() methods implement the XPath comparison semantics
    ...
    private static final class Base64Encoder {
         ...
         */
        public final void translate(/*@NotNull*/ byte[] in) {
    ...
    private static final class Base64Decoder {
        /*@NotNull*/ private ByteArrayOutputStream out = new ByteArrayOutputStream();

        /*@NotNull*/ private byte token[] = new byte[4];      // input buffer

        /*@NotNull*/ private byte bytes[] = new byte[3];      // output buffer
        ...
        /*@NotNull*/ private static final byte[] map = {
        ...
        public final void translate(/*@NotNull*/ CharSequence str) throws IllegalArgumentException {
...
//
// Portions created by Netscape Communications Corporation are Copyright (C) Netscape Communications Corporation. All Rights Reserved.
//
// Contributor(s): Netscape Communications Corporation.
//
