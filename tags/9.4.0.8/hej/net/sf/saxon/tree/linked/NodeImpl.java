...
public abstract class NodeImpl
   ...
   public boolean equals(Object other) {
    ...
    /*@Nullable*/ public final NodeInfo getParent() {
    ...
    /*@Nullable*/ public NodeInfo getPreviousSibling() {
        if (parent == null) {
            return null;
        }
    ...
    /*@Nullable*/ public NodeInfo getNextSibling() {
        if (parent == null) {
            return null;
        }
        return parent.getNthChild(index + 1);
    ...
    /*@Nullable*/ public NodeInfo getFirstChild() {
        return null;
    }
