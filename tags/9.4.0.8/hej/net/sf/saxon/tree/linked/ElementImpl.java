...
public class ElementImpl extends ParentNodeImpl implements NamespaceResolver {
    ...
    */
    ...
    /*@Nullable*/ public final String getSystemId() {
    ...
    */
    ...
    /*@Nullable*/ public String getPrefixForURI(/*@NotNull*/ String uri) {
    ...
    protected void fixupInsertedNamespaces(boolean inherit) {
        ...
        if (namespaceList != null) {
            for (int i = 0; i < namespaceList.length; i++) {
                NamespaceBinding nscode = namespaceList[i];
        ...
        int j = 0;
        Iterator<NamespaceBinding> ii = childNamespaces.iterator();
        while (ii.hasNext()) {
            n2[j++] = ii.next();
        }
        namespaceList = n2;
    ...
    /*@Nullable*/ public NamespaceBinding[] getNamespaceList() {
