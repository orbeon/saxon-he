...
public abstract class Type implements Serializable {
    ...
    /*@Nullable*/ public static ItemType getBuiltInItemType(String namespace, String localName) {
    ...
    /*@Nullable*/ public static SimpleType getBuiltInSimpleType(String namespace, String localName) {
        SchemaType t = BuiltInType.getSchemaType(
                StandardNames.getFingerprint(namespace, localName));
    ...
    /*@NotNull*/ public static ItemType getCommonSuperType(/*@NotNull*/ ItemType t1, /*@NotNull*/ ItemType t2, /*@NotNull*/ TypeHierarchy th) {
    	if (t1 == t2) {
    		return t1;
    	}
    ...
    public static boolean isComparable(/*@NotNull*/ BuiltInAtomicType t1, /*@NotNull*/ BuiltInAtomicType t2, boolean ordered) {
        if (t1 == t2) {
