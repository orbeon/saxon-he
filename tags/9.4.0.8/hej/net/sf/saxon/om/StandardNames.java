...
public abstract class StandardNames {
    ...
    public static final int XSL_MERGE_ACTION = XSL + 40;
    public static final int XSL_MERGE_INPUT = XSL + 41; //CHANGED FROM 'XSL+40'
    public static final int XSL_MERGE_KEY = XSL + 42;
    public static final int XSL_MERGE_SOURCE = XSL + 43; //CHANGED FROM 'XSL+41'
    public static final int XSL_MESSAGE = XSL + 44; //CHANGED FROM 'XSL+42'
