...
public class GlobalVariableDefinition implements VariableDeclaration, Declaration {
    ...
    /*@Nullable*/ public GlobalVariable compile(/*@NotNull*/ Executable exec, int slot) throws XPathException {
        ...
        var.setLocationId(exec.getLocationMap().allocateLocationId(systemId, lineNumber));
    ...
    public void typeCheck(/*@NotNull*/ ExpressionVisitor visitor) throws XPathException {
        GlobalVariable var = getCompiledVariable(); // will be null if the variable is unreferenced
        Expression value = (var == null ? null : var.getSelectExpression());
        if (value != null) {
