...
public class IntegratedFunctionCall extends FunctionCall implements CallableExpression {
     ...
     * @throws net.sf.saxon.trans.XPathException if the arguments are statically determined to be incompatible
    ...
    */
    ...
    public boolean effectiveBooleanValue(XPathContext context) throws XPathException {
        SequenceIterator<? extends Item>[] argValues = new SequenceIterator[getNumberOfArguments()];
        for (int i=0; i<argValues.length; i++) {
            argValues[i] = argument[i].iterate(context);
        }
        try {
