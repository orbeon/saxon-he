...
public class EscapeURI extends SystemFunction implements CallableExpression {
    ...
    */
    ...
    public SequenceIterator call(SequenceIterator[] arguments, XPathContext context) throws XPathException {
        return Value.asIterator(evalEscapeURI(arguments[0].next(), context));
    }

    private Item evalEscapeURI(/*@Nullable*/ Item item, XPathContext c) throws XPathException {
        if (item == null) {
