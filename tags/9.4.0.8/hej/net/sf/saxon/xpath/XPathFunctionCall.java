...
public class XPathFunctionCall extends FunctionCall implements CallableExpression {
    ...
    */
    ...
    public SequenceIterator iterate(/*@NotNull*/ XPathContext context) throws XPathException {
        SequenceIterator[] argValues = new SequenceIterator[argument.length];
    ...
    /*@Nullable*/ public SequenceIterator call(/*@NotNull*/ SequenceIterator[] argValues, /*@NotNull*/ XPathContext context) throws XPathException {
        ...
        for (int i=0; i<argValues.length; i++) {
            ...
            SequenceIterator iter = argValues[i];
            while (true) {
                Item item = iter.next();
                if (item == null) {
                    break;
