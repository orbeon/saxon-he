...
public class ArithmeticExpression extends BinaryExpression {
    ...
    public Expression typeCheck(ExpressionVisitor visitor, ExpressionVisitor.ContextItemType contextItemType) throws XPathException {
        ...
        if (type0.getFingerprint() == StandardNames.XS_UNTYPED_ATOMIC) {
        	operand0 = AtomicSequenceConverter.makeUntypedSequenceConverter(visitor.getConfiguration(), operand0, BuiltInAtomicType.DOUBLE);
        ...
        if (type1.getFingerprint() == StandardNames.XS_UNTYPED_ATOMIC) {
        	operand1 = AtomicSequenceConverter.makeUntypedSequenceConverter(visitor.getConfiguration(), operand1, BuiltInAtomicType.DOUBLE);
