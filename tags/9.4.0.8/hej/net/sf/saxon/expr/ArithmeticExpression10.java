...
public class ArithmeticExpression10 extends BinaryExpression implements CallableExpression {
    ...
    private Expression createConversionCode(
        ...
        if (th.isSubType(type, BuiltInAtomicType.BOOLEAN) ||
            ...
            if (operand instanceof Literal) {
                ...
                return new Literal(NumberFn.convert((AtomicValue)val, config));
            } else {
    ...
    public SequenceIterator call(SequenceIterator[] arguments, XPathContext context) throws XPathException {
        Calculator calc = calculator;
        AtomicValue v1 = (AtomicValue) arguments[0].next();
        if (v1 == null) {
            return Value.asIterator(DoubleValue.NaN);
        }

        AtomicValue v2 = (AtomicValue) arguments[1].next();
        if (v2 == null) {
            return Value.asIterator(DoubleValue.NaN);
        }
        ...
        return Value.asIterator(calc.compute(v1, v2, context));
    }
}
