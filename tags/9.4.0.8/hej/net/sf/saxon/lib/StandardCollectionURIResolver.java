...
public class StandardCollectionURIResolver implements CollectionURIResolver {
    ...
    private SequenceIterator<DocumentInfo> directoryContents(File directory, URIQueryParameters params, XPathContext context) {
    ...
    private SequenceIterator<? extends NodeInfo> catalogContents(String href, String baseURI, String absURI, final XPathContext context)
    ...
    private static class FileExpander implements MappingFunction<ObjectValue, DocumentInfo> {
