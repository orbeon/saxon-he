...
public class IndependentContext extends AbstractStaticContext
        implements XPathStaticContext, NamespaceResolver, Container {
    ...
    public PackageData getPackageData() {
        if (packageData == null) {
            packageData = new PackageData(getConfiguration());
            packageData.setAllowXPath30(getXPathLanguageLevel().equals(DecimalValue.THREE));
            packageData.setHostLanguage(getHostLanguage());
            packageData.setLocationMap(getLocationMap());
    ...
    public void setSchemaAware(boolean aware) {
        ...
        if (packageData != null) {
            packageData.setSchemaAware(aware);
        }
    }
