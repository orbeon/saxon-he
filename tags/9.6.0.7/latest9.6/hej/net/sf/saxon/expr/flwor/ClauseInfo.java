...
public class ClauseInfo implements InstructionInfo {
    ...
    public String getSystemId() {
        return container.getPackageData().getLocationMap().getSystemId(clause.getLocationId());
    }
    ...
    public int getLineNumber() {
        return container.getPackageData().getLocationMap().getLineNumber(clause.getLocationId());
    }
