...
//        }
    ...
    public Expression optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        if (operand instanceof Literal) {
            return preEvaluate(visitor.getStaticContext().getXPathLanguageLevel().equals(DecimalValue.THREE));
        }
        return this;
    }
    ...
    protected Expression preEvaluate(boolean isXPath30) throws XPathException {
        ...
        if (literalOperand instanceof AtomicValue && converter != null) {
            ...
            if (result instanceof ValidationFailure) {
                ...
                return Literal.makeLiteral((AtomicValue) result, getContainer());
            }
        }
    ...
    private AtomicValue doCast(AtomicValue value, XPathContext context) throws XPathException {
        ...
        if (converter == null) {
            ...
            if (converter.isXPath30Conversion() && !getContainer().getPackageData().isAllowXPath30() &&
                    !(converter instanceof StringConverter.StringToQName && isOperandIsStringLiteral())) {
    ...
    public String toShortString() {
        return getTargetType().getDisplayName() + "(" + operand.toShortString() + ")";
    }
