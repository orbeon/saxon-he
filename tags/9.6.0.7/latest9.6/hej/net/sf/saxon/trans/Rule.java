...
public final class Rule {
    ...
    public boolean matches(Item item, XPathContextMajor context) throws XPathException {
        ...
        Component saved = context.getCurrentComponent();
        context.setCurrentComponent(getAction().getDeclaringComponent());
        boolean b = pattern.matches(item, context);
        context.setCurrentComponent(saved);
        return b;
    }
