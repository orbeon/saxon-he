...
public class CommandLineOptions {
    ...
    public void applyToConfiguration(/*@NotNull*/ final Processor processor) throws TransformerException {
        ...
        if (value != null) {
            ...
            processor.setConfigurationProperty(FeatureKeys.COLLECTION_URI_RESOLVER, resolver);
        }
        ...
        if (value != null) {
            processor.setConfigurationProperty(FeatureKeys.SOURCE_PARSER_CLASS, value);
        }
        ...
        if (value != null) {
            processor.setConfigurationProperty(FeatureKeys.XSLT_VERSION, value);
        }
    ...
    public void setParams(Processor processor, ParamSetter paramSetter)
        ...
        for (Enumeration e = paramFiles.propertyNames(); e.hasMoreElements(); ) {
            ...
            if (sourceList.size() > 0) {
                List<XdmNode> nodeList = new ArrayList<XdmNode>(sourceList.size());
    ...
    public void setSerializationParams(Serializer serializer) {
        for (Enumeration e = serializationParams.propertyNames(); e.hasMoreElements(); ) {
            ...
            serializer.setOutputProperty(Serializer.getProperty(QName.fromClarkName(name)), value);
        }
    }
    ...
    public static List<String> buildStylesheetFileList(Configuration config, String additionalStyleFile) throws XPathException {
        StringTokenizer st = new StringTokenizer(additionalStyleFile, ";");
        List<String> list = new ArrayList<String>();
        while (st.hasMoreTokens()) {
            String styleFileName = st.nextToken();
            list.add(styleFileName);
        }
        return list;
    }
    ...
    public static String showExecutionTimeNano(long nanosecs) {
        if (nanosecs < 1e9) {
            ...
            try {
                ...
                long days = ((NumericValue) d.getComponent(AccessorFn.DAY)).longValue();
                long hours = ((NumericValue) d.getComponent(AccessorFn.HOURS)).longValue();
                long minutes = ((NumericValue) d.getComponent(AccessorFn.MINUTES)).longValue();
                BigDecimal seconds = ((NumericValue) d.getComponent(AccessorFn.SECONDS)).getDecimalValue();
