...
public class JDOMNodeWrapper extends AbstractNodeWrapper implements SiblingCountingNode {
    ...
    private static class DescendantWrappingIterator extends NodeWrappingAxisIterator<Object> {
        ...
        public DescendantWrappingIterator(Iterator<Object> descendantIterator, NodeWrappingFunction<Object, NodeInfo> wrappingFunction) {
    ...
    private final class AttributeEnumeration extends AxisIteratorImpl {
        ...
        public final NodeInfo next() {
            if (atts.hasNext()) {
                return makeWrapper(atts.next(), docWrapper, start, ix++);
            } else {
                return null;
            }
        }
            ...
            if (forwards) {
                if (children.hasNext()) {
                    ...
                    if (nextChild instanceof EntityRef) {
                        ...
                        JDOMNodeWrapper current = makeWrapper(nextChild, docWrapper, commonParent, ix++);
                        ...
                        return makeWrapper(nextChild, docWrapper, commonParent, ix++);
                    }
                } else {
                    return null;
                }
