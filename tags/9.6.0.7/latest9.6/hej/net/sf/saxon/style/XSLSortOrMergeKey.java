...
public abstract class XSLSortOrMergeKey extends StyleElement {
    ...
    public void validate(ComponentDeclaration decl) throws XPathException {
        ...
        if (useDefaultCollation) {
            collationName = new StringLiteral(getDefaultCollationName(), this);
        }
        ...
        sortKeyDefinition = new SortKeyDefinition(this);
    ...
    protected void prepareAttributes() throws XPathException {
        ...
        if (orderAtt == null) {
            order = new StringLiteral("ascending", this);
        } else {
        ...
        if (caseOrderAtt == null) {
            caseOrder = new StringLiteral("#default", this);
        } else {
