        ...
        if (isException()) {
           ...
           /* String expectedDoctype = null;
            ...
            try {
                ...
                boolean success = DeepEqual.deepEquals(
                        iter0, iter1,
                ...
                if (!success) {
                    ...
                    iter0 = new ItemMappingIterator<NodeInfo, NodeInfo>(iter0, new RemoveWhitespace());
                    iter1 = new ItemMappingIterator<NodeInfo, NodeInfo>(iter1, new RemoveWhitespace());
                    success = DeepEqual.deepEquals(
                            iter0, iter1,
                            new GenericAtomicComparer(CodepointCollator.getInstance(), null),
