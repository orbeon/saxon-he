...
public class UnboundFunctionLibrary implements FunctionLibrary {
    ...
    /*@Nullable*/
    public Expression bind(SymbolicName functionName, /*@NotNull*/  Expression[] arguments, StaticContext env, Container container) throws XPathException {
        if (resolving) {
            return null;
        }
...
//#ifdefined HOF
    ...
    public FunctionItem getFunctionItem(SymbolicName functionName, StaticContext staticContext, Container container) throws XPathException {
        ...
        CallableFunctionItem fi = new CallableFunctionItem(functionName, uc, AnyFunctionType.getInstance());
