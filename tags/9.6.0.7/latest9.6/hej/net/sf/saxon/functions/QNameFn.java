...
public class QNameFn extends SystemFunctionCall {
    ...
    public Expression preEvaluate(ExpressionVisitor visitor) throws XPathException {
        try {
            ...
            return Literal.makeLiteral(
                    new QNameValue(parts[0], uri, parts[1], BuiltInAtomicType.QNAME, true), getContainer());
    ...
    public QNameValue evaluateItem(XPathContext context) throws XPathException {
        ...
        return expandedQName(arg0, arg1);
    }

    public QNameValue expandedQName(StringValue namespace, StringValue lexical) throws XPathException {
