...
public abstract class StandardNames {
    ...
    public static final int XSL_CHARACTER_MAP = XSL + 12;
    public static final int XSL_CHOOSE = XSL + 13;
    public static final int XSL_COMMENT = XSL + 14;
    ...
    public static final int XSL_EXPOSE = XSL + 20;
    public static final int XSL_EVALUATE = XSL + 21;
    ...
    public static final int XSL_OVERRIDE = XSL + 57;
    public static final int XSL_OUTPUT_CHARACTER = XSL + 58;
    public static final int XSL_PACKAGE = XSL + 59;
    ...
    public static final int XSL_WITH_PARAM = XSL + 80;
    ...
    public static final String IDENTITY_SENSITIVE = "identity-sensitive";
    ...
    public static final String OVERRIDE_EXTENSION_FUNCTION = "override-extension-function";
    ...
    public static final StructuredQName SAXON_CONTEXT_ITEM =
            new StructuredQName("saxon", NamespaceConstant.SAXON, "context-item");
