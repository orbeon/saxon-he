...
public class FLWORExpression extends Expression {
    ...
    public Expression typeCheck(final ExpressionVisitor visitor, final ContextItemStaticInfo contextInfo)
        ...
        ExpressionProcessor typeChecker = new ExpressionProcessor() {
            public Expression processExpression(Expression expr) throws XPathException {
                return visitor.typeCheck(expr,  contextInfo);
            }
        };
        ...
        returnClause = visitor.typeCheck(returnClause,  contextInfo);
        return this;
    }
    ...
    public Iterable<Operand> operands() {
        ...
        ExpressionProcessor processor = new ExpressionProcessor() {
            public Expression processExpression(Expression expr) {
                list.add(new Operand(expr, OperandRole.NAVIGATE));
                return expr;
            }
        };
        ...
        list.add(new Operand(returnClause, foundLoopClause ? REPEATED_RETURN : SINGLE_RETURN));
        return list;
    ...
    @Override
    public boolean replaceOperand(final Expression original, final Expression replacement) {
    ...
    public Expression unordered(boolean retainAllNodes, boolean forStreaming) throws XPathException {
        ...
        returnClause = returnClause.unordered(retainAllNodes, forStreaming);
        return this;
    }
