...
import com.saxonica.ee.bytecode.ProcessRegexMatchInstructionCompiler;
...
public class ProcessRegexMatchInstruction extends Instruction {
    ...
    public TailCall processLeavingTail(XPathContext context) throws XPathException {
        FocusIterator fi = context.getCurrentIterator();
        SequenceIterator iter = ((FocusTrackingIterator)fi).getUnderlyingIterator();
