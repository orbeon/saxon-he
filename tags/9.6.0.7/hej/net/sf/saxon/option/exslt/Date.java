...
public final class Date {
    ...
    public static double year(XPathContext context, String datetimeIn) {
        ...
        try {
            ...
            AtomicValue year = ((CalendarValue) cr).getComponent(AccessorFn.YEAR);
    ...
    public static double monthInYear(XPathContext context, String dateTime) {
        ...
        try {
            ...
            AtomicValue month = ((CalendarValue) cr).getComponent(AccessorFn.MONTH);
    ...
    public static double dayInMonth(XPathContext context, String dateTime) {
        ...
        try {
            ...
            AtomicValue day = ((CalendarValue) cr).getComponent(AccessorFn.DAY);
    ...
    public static double hourInDay(XPathContext context, String dateTime) {
        ...
        try {
            ...
            AtomicValue hour = ((CalendarValue) cr).getComponent(AccessorFn.HOURS);
    ...
    public static double minuteInHour(XPathContext context, String dateTime) {
        ...
        try {
            ...
            AtomicValue minute = ((CalendarValue) cr).getComponent(AccessorFn.MINUTES);
    ...
    public static double secondInMinute(XPathContext context, String dateTime) {
        ...
        try {
            ...
            AtomicValue second = ((CalendarValue) cr).getComponent(AccessorFn.SECONDS);
    ...
    private static DurationValue addDurationValues(DurationValue dv0, DurationValue dv1) {
        YearMonthDurationValue dv0m =
                (YearMonthDurationValue) Converter.DURATION_TO_YEAR_MONTH_DURATION.convert(dv0);
        DayTimeDurationValue dv0s =
                (DayTimeDurationValue) Converter.DURATION_TO_DAY_TIME_DURATION.convert(dv0);
        YearMonthDurationValue dv1m = (YearMonthDurationValue) Converter.DURATION_TO_YEAR_MONTH_DURATION.convert(dv1);
        DayTimeDurationValue dv1s =
                (DayTimeDurationValue) Converter.DURATION_TO_DAY_TIME_DURATION.convert(dv1);
