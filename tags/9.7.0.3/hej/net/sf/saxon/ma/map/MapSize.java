 ...
 */
public class MapSize extends ExtensionFunctionDefinition {

    private final static StructuredQName name = new StructuredQName("map", NamespaceConstant.MAP_FUNCTIONS, "size");
    private final static SequenceType[] ARG_TYPES = new SequenceType[]{HashTrieMap.SINGLE_MAP_TYPE};
