...
final class SiblingIterator extends AxisIteratorImpl implements LookaheadIterator, AtomizedValueIterator {
    ...
    /*@NotNull*/
    public SiblingIterator getAnother() {
        return new SiblingIterator(tree, startNode, test, getChildren);
    }

    public int getProperties() {
        return LOOKAHEAD | ATOMIZING;
    }
