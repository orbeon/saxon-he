...
public final class DocumentOrderIterator<T extends NodeInfo> implements SequenceIterator<T>, Sortable {
     ...
     * @throws ClassCastException if the sequence contains an item that is not a node
     */
    ...
    public DocumentOrderIterator(SequenceIterator<? extends T> base, ItemOrderComparer comparer) throws XPathException {
        ...
        base.forEachOrFail(sequence::add);
