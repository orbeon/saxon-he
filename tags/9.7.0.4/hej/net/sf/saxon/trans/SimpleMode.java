...
public class SimpleMode extends Mode {
    ...
    protected IntHashMap<Rule> namedElementRuleChains = new IntHashMap<Rule>(32);
    protected IntHashMap<Rule> namedAttributeRuleChains = new IntHashMap<Rule>(8);
    ...
    public void processRuleChains(IntHashMap<Rule> chains, RuleAction action, RuleGroupAction group) throws XPathException {
        if (chains.size() > 0) {
            if (group != null) {
                group.start();
            }
