...
public class UseWhenStaticContext extends AbstractStaticContext implements XSLTStaticContext {
    ...
    public UseWhenStaticContext(Compilation compilation, NamespaceResolver namespaceContext) {
        ...
        int functionLib = StandardFunction.CORE | StandardFunction.USE_WHEN;
        if (getXPathVersion() >= 30) {
            functionLib |= StandardFunction.XPATH30;
            functionLib |= StandardFunction.XPATH31;
        }

        FunctionLibraryList lib = new FunctionLibraryList();
        lib.addFunctionLibrary(SystemFunctionLibrary.getSystemFunctionLibrary(functionLib, config));
