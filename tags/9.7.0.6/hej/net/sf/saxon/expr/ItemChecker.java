...
//#ifdefined STREAM
    ...
    public ItemMappingFunction getMappingFunction(XPathContext context) {
        return new ItemTypeCheckingFunction<Item>(requiredItemType, role, getLocation(), context.getConfiguration());
    }
...
//#endif
    ...
    public Expression optimizeForType(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        if(base instanceof ContextItemExpression &&
                requiredItemType.equals(contextItemType.getItemType())) {
            return base;
        }
        return this;
    }
