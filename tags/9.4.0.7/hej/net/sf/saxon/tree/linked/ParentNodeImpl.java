...
abstract class ParentNodeImpl extends NodeImpl {
    ...
    */
    ...
    /*@Nullable*/ protected final AxisIterator enumerateChildren(/*@Nullable*/ NodeTest test) {
        if (children==null) {
    ...
    */
    ...
    /*@Nullable*/ public final NodeInfo getFirstChild() {
    ...
    */
    ...
    /*@Nullable*/ public final NodeInfo getLastChild() {
        if (children==null) return null;
        if (children instanceof NodeImpl) return (NodeImpl)children;
