 ...
 */
public class Contains extends CollatingFunction implements CallableExpression  {
	...
	public boolean effectiveBooleanValue(XPathContext context) throws XPathException {
		...
		return contains(s0, s1, context);
	}

	public boolean contains(String s0, String s1, XPathContext context) throws XPathException{
	...
	public SequenceIterator call(SequenceIterator[] arguments,
		...
		String s0 =arguments[0].next().getStringValue();
		String s1 =arguments[1].next().getStringValue();
		BooleanValue value = BooleanValue.get( contains(s0, s1, context));
