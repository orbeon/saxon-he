...
public abstract class Math  {
    ...
    */
    ...
    public static Value highest (XPathContext context, SequenceIterator nsv) throws XPathException {
        double max = Double.NEGATIVE_INFINITY;
        StringToDouble converter = context.getConfiguration().getConversionRules().getStringToDoubleConverter();
        try {
    ...
    */
    ...
    public static Value lowest (XPathContext context, SequenceIterator nsv) throws XPathException {
        double min = Double.POSITIVE_INFINITY;
        StringToDouble converter = context.getConfiguration().getConversionRules().getStringToDoubleConverter();
        try {
...
// Portions created by Simon St.Laurent [simonstl@simonstl.com] (marked SStL) are Copyright (C) Simon St.Laurent [simonstl@simonstl.com]. All rights reserved.
//
// Contributor(s): Simon St.Laurent
//
