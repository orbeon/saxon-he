...
public abstract class NodeOverNodeInfo implements Node {
    ...
    */
    ...
    public Node getPreviousSibling()  {
        return wrap(node.iterateAxis(Axis.PRECEDING_SIBLING).next());
    }
    ...
    */
    ...
    public Node getNextSibling()  {
        return wrap(node.iterateAxis(Axis.FOLLOWING_SIBLING).next());
    }
    ...
    */
    ...
    public Node getFirstChild()  {
        return wrap(node.iterateAxis(Axis.CHILD).next());
    }
