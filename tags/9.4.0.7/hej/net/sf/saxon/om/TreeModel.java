...
//    public final static TreeModel JDOM_TREE = new JDOMObjectModel();
//
//    public final static TreeModel JDOM2_TREE = new JDOM2ObjectModel();

    /**
     * Make a Builder to construct an instance of this tree model from a stream of events
     * @return a newly created Builder @param pipe
     */
...
//            case Builder.JDOM_TREE:
//                return TreeModel.JDOM_TREE;
//            case Builder.JDOM2_TREE:
//                return TreeModel.JDOM2_TREE;
            default:
