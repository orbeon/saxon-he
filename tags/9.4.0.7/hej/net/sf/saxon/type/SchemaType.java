...
public interface SchemaType extends SchemaComponent {
    ...
    */
     ...
     * @throws net.sf.saxon.trans.XPathException if the node has no typed value (typically, if it is an element with
     * an element-only content type)
     */

    SequenceIterator<? extends AtomicValue> getTypedValue(NodeInfo node) throws XPathException;
    ...
    Value<? extends AtomicValue> atomize(NodeInfo node) throws XPathException;
