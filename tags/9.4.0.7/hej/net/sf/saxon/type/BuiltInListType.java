...
public class BuiltInListType implements ListType, Serializable {
    ...
    */
    ...
    /*@NotNull*/ public SequenceIterator getTypedValue(/*@NotNull*/ NodeInfo node) throws XPathException {
        try {
    ...
    public Value atomize(/*@NotNull*/ NodeInfo node) throws XPathException {
        return new SequenceExtent<AtomicValue>(getTypedValue(node)).simplify();
    }
    ...
    */
    ...
    /*@NotNull*/ public SimpleType getItemType() {
        return itemType;
    }
    ...
    /*@Nullable*/ public ValidationFailure validateContent(
    ...
    /*@NotNull*/ public SequenceIterator<AtomicValue> getTypedValue(/*@NotNull*/ CharSequence value, NamespaceResolver resolver, ConversionRules rules) throws ValidationException {
    ...
    /*@NotNull*/ private static BuiltInListType makeListType(String namespace, String lname) {
    ...
    private static class ListTypeMappingFunction implements MappingFunction<StringValue, AtomicValue> {
        ...
        */
        ...
        public SequenceIterator<AtomicValue> map(/*@NotNull*/ StringValue item) throws XPathException {
            try {
                return atomicType.getTypedValue(item.getStringValue(), resolver, rules);
            } catch (ValidationException err) {
