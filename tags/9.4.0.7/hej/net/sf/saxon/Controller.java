...
public class Controller extends Transformer {
    ...
    /*@Nullable*/ public String getOutputProperty(String name) {
         try {
    ...
    /*@Nullable*/ public String getBaseOutputURI() {
    ...
    /*@Nullable*/ public String getCookedBaseOutputURI() {
    ...
    /*@Nullable*/ public Result getPrincipalResult() {
    ...
    public boolean checkUniqueOutputDestination(/*@Nullable*/ DocumentURI uri) {
        if (uri == null) {
    ...
    /*@NotNull*/ public SequenceOutputter allocateSequenceOutputter(int size) {
    ...
    /*@Nullable*/ public String getInitialTemplate() {
    ...
    /*@Nullable*/ public Receiver getMessageEmitter() {
    ...
    /*@Nullable*/ public Item getInitialContextItem() {
    ...
    /*@Nullable*/ public Item getContextForGlobalVariables() {
    ...
    /*@Nullable*/ public OutputURIResolver getOutputURIResolver() {
    ...
    /*@Nullable*/ public SchemaURIResolver getSchemaURIResolver() {
    ...
    /*@NotNull*/ public CollectionURIResolver getCollectionURIResolver() {
     ...
     */
    /*@Nullable*/ public TraceListener getTraceListener() { // e.g.
    ...
    /*@Nullable*/ public Receiver getStreamingReceiver(Mode mode, Result result)
    throws TransformerException {
        // System.err.println("*** TransformDocument");
        if (executable==null) {
            throw new XPathException("Stylesheet has not been compiled");
    ...
    private Result openResult(Result result, XPathContextMajor initialContext) throws TransformerException {
        ...
        initialContext.changeOutputDestination(receiver, Validation.PRESERVE, null);
    ...
    /*@Nullable*/ public DateTimeValue getCurrentDateTime() {
        if (currentDateTime==null) {
    ...
    /*@Nullable*/ public PathMap getPathMapForDocumentProjection() {
        return pathMap;
    }
...
// Portions created by Edwin Glaser (marked e.g.) are Copyright (C) Edwin Glaser (edwin@pannenleiter.de). All rights reserved.
//
// Contributor(s): Edwin Glaser
//
