...
public class UnboundFunctionLibrary implements FunctionLibrary {
    ...
    /*@NotNull*/ private List unboundFunctionCalls = new ArrayList(20);
    /*@NotNull*/ private List correspondingStaticContext = new ArrayList(20);
    ...
    */
    ...
    /*@Nullable*/ public Expression bind(StructuredQName functionName, /*@NotNull*/ Expression[] arguments, StaticContext env, Container container) throws XPathException {
        if (resolving) {
            return null;
        }
    ...
    public void bindUnboundFunctionCalls(/*@NotNull*/ XQueryFunctionBinder lib, /*@NotNull*/ Configuration config) throws XPathException {
        resolving = true;
