...
public class Substring extends SystemFunction implements Callable {
    ...
    public ZeroOrOne<StringValue> call(XPathContext context, Sequence[] arguments) throws XPathException {
        ...
        if (arguments.length == 2) {
            return new ZeroOrOne<StringValue>(StringValue.makeStringValue(substring(arg0, arg1)));
        } else {
            NumericValue arg2 = (NumericValue) arguments[2].head();
            return new ZeroOrOne<StringValue>(StringValue.makeStringValue(substring(arg0, arg1, arg2)));
        }
    }
