    ...
    public void compile() throws XPathException {
        ...
        try {
            ...
            if (compiledFunction == null) {
                ...
                RetainedStaticContext rsc = getStaticContext().makeRetainedStaticContext();
...
//            }
    ...
    public void optimize() throws XPathException {
        ...
        if (opt.getOptimizationLevel() != Optimizer.NO_OPTIMIZATION) {
            body = body.optimize(visitor, ContextItemStaticInfo.DEFAULT);
            ...
            GlobalVariableManager manager = new GlobalVariableManager() {
                ...
                public Collection<StructuredQName> getGlobalVariableNames() {
                    return getPackageData().getGlobalSlotManager().getVariableMap();
                }
    ...
    public void checkReferences(ExpressionVisitor visitor) throws XPathException {
        ...
        references = new ArrayList<UserFunctionResolvable>(0);
