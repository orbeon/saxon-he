...
//    };
    ...
    private static IntHashMap<UType> axisTransitions = new IntHashMap<UType>(50);
    ...
    private static int makeKey(PrimitiveUType origin, byte axis) {
        return origin.getBit()<<16 | (int)axis;
    }
    ...
    public static UType getTargetUType(UType origin, byte axis) {
        ...
        Set<PrimitiveUType> origins = origin.decompose();
    ...
    static {
        ...
        e(PrimitiveUType.ATTRIBUTE, FOLLOWING, UType.CHILD_NODE_KINDS);  // TODO
        ...
        e(PrimitiveUType.ATTRIBUTE, PRECEDING, UType.CHILD_NODE_KINDS); // TODO
        ...
        e(PrimitiveUType.NAMESPACE, FOLLOWING, UType.CHILD_NODE_KINDS);  // TODO
        ...
        e(PrimitiveUType.NAMESPACE, PRECEDING, UType.CHILD_NODE_KINDS); // TODO
