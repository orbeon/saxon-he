...
public class XQueryCompiler {
     ...
     *
     * @param value Must be "1.0" or "3.0". The value "3.1" is currently accepted
     * as a synonym for "3.0".
    ...
    public void setLanguageVersion(String value) {
        ...
        if ("1.0".equals(value)) {
            ...
            throw new IllegalArgumentException("XQuery version: " + value);
        }
