...
//    }
    ...
    public final static class CharacterIterator implements UnfailingIterator {
    ...
    public final static class UnicodeCharacterIterator implements UnfailingIterator {
        ...
        /*@NotNull*/
        public UnfailingIterator getAnother() {
            return new UnicodeCharacterIterator(uValue);
        }
