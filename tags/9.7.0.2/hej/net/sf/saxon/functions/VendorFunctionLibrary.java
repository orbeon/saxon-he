...
public class VendorFunctionLibrary extends IntegratedFunctionLibrary {
    ...
    protected void init() {
        ...
        registerFunction(new ExsltNodeSet());
    }
    ...
    /*@Nullable*/
    public Expression makeSaxonFunction(String localName, Expression[] arguments, StaticContext env)
