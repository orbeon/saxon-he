...
public class CollatingFunctionFree extends SystemFunction {
    ...
    public Expression makeOptimizedFunctionCall(ExpressionVisitor visitor, ContextItemStaticInfo contextInfo, Expression... arguments) throws XPathException {
        ...
        if (c instanceof Literal) {
            CollatingFunctionFixed fn = bindCollation(((Literal)c).getValue().getStringValue());
    ...
    public CollatingFunctionFixed bindCollation(String collationName) throws XPathException {
        CollatingFunctionFixed fixed = (CollatingFunctionFixed)SystemFunctionLibrary.makeSystemFunction(
            getFunctionName().getLocalPart(), getArity()-1, -1);
    ...
    public StreamingAdjunct getStreamingAdjunct() {
        try {
            return bindCollation(NamespaceConstant.CODEPOINT_COLLATION_URI).getStreamingAdjunct();
