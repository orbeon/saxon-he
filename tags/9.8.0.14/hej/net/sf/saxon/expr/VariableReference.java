...
public abstract class VariableReference extends Expression implements BindingReference {
    ...
    protected void copyFrom(VariableReference ref) {
        ...
        //#ifdefined STREAM
        Streamability.setPostureAndSweep(this, Streamability.getPostureAndSweepIfKnown(ref));
        //#endif
...
//            }
    ...
    public Expression optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        if (constantValue != null) {
            binding = null;
            Expression result = Literal.makeLiteral(constantValue);
    ...
    public void process(XPathContext c) throws XPathException {
        try {
            ...
            while ((item = iter.next()) != null) {
                out.append(item, loc, NodeInfo.ALL_NAMESPACES);
            }
        } catch (XPathException err) {
            err.maybeSetLocation(getLocation());
            throw err;
