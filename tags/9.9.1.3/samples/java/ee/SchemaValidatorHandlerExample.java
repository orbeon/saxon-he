...
public class SchemaValidatorHandlerExample {
    ...
    public static class LocalContentHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) {
            ...
            sb.append("Element ").append(qName);
            sb.append(" of type {")
                    .append(etype.getTypeNamespace())
                    .append('}')
                    .append(etype.getTypeName());
            ...
            for (int a=0; a<attributes.getLength(); a++) {
                ...
                sb.append("Attribute ")
                        ...
                        .append(spec ? " (specified)" : " (defaulted)");
                if (atype == null) {
                    sb.append(" of unknown type");
                } else {
                    sb.append(" of type {")
                            .append(atype.getTypeNamespace())
                            .append('}')
                            .append(atype.getTypeName());
                }
                System.out.println(sb);
            }
            indent++;
    ...
    public static void main(String [] args) {
        try {
            ...
            if (errorCount == 0) {
                ...
                System.err.println("Validation complete: found " + errorCount + " error" + (errorCount==1?"":"s"));
            }
