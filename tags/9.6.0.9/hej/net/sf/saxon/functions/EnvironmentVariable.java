...
public class EnvironmentVariable extends SystemFunctionCall implements Callable {
    ...
    public StringValue evaluateItem(XPathContext context) throws XPathException {
        return getVariable((StringValue) argument[0].evaluateItem(context), context);
    }
    ...
    private StringValue getVariable(StringValue environVar, XPathContext context) throws XPathException {
