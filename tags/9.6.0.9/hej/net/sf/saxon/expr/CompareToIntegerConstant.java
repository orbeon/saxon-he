...
public class CompareToIntegerConstant extends Expression implements ComparisonExpression {
    ...
    public Iterable<Operand> operands() {
        return operandList(
                new Operand(operand, OperandRole.SINGLE_ATOMIC));
    }
    ...
    public Expression optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        if (operand instanceof Literal) {
            Literal lit = Literal.makeLiteral(BooleanValue.get(effectiveBooleanValue(null)), getContainer());
...
//#endif
    ...
    public String toShortString() {
        return operand.toShortString() + " " + Token.tokens[operator] + " " + comparand;
    }
    ...
    public Expression[] getOperands() {
        Literal lit = Literal.makeLiteral(Int64Value.makeIntegerValue(comparand), getContainer());
        return new Expression[]{operand, lit};
    }
