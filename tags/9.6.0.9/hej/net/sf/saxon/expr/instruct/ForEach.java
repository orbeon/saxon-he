...
public class ForEach extends Instruction implements ContextMappingFunction, ContextSwitchingExpression {
    ...
    public Expression typeCheck(ExpressionVisitor visitor, ContextItemStaticInfo contextInfo) throws XPathException {
        ...
        ContextItemStaticInfo cit = new ContextItemStaticInfo(select.getItemType(), false, select);
...
//        }
    ...
    public Expression optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        adoptChildExpression(select);
        ContextItemStaticInfo cit = new ContextItemStaticInfo(select.getItemType(), false, select);
        action = action.optimize(visitor, cit);
        adoptChildExpression(action);
    ...
    public Iterable<Operand> operands() {
        Operand selectInfo = new Operand(select, OperandRole.FOCUS_CONTROLLING_SELECT);
        Operand actionInfo = new Operand(action, OperandRole.FOCUS_CONTROLLED_ACTION);
        if (threads == null) {
            return operandList(selectInfo, actionInfo);
        } else {
            Operand threadsInfo = new Operand(threads, OperandRole.SINGLE_ATOMIC);
            return operandList(selectInfo, actionInfo, threadsInfo);
        }
    }
    ...
    public TailCall processLeavingTail(XPathContext context) throws XPathException {
        ...
        FocusIterator iter = new FocusTrackingIterator(select.iterate(context));
    ...
    public SequenceIterator iterate(XPathContext context) throws XPathException {
        FocusIterator master = new FocusTrackingIterator(select.iterate(context));
    ...
    public String toShortString() {
        return select.toShortString() + "!" + action.toShortString();
    }
