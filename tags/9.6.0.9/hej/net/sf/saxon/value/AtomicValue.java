...
public abstract class AtomicValue extends AbstractItem
     ...
     *                  {@link net.sf.saxon.functions.AccessorFn}, for example {@link net.sf.saxon.functions.AccessorFn#HOURS}
    ...
    public Iterator<AtomicValue> iterator() {
        return new MonoIterator<AtomicValue>(head());
    }
    ...
    public final static AtomicMatchKey NaN_MATCH_KEY = new QNameValue("", NamespaceConstant.SAXON, "+NaN+");
