...
public class NamespaceReducer extends ProxyReceiver implements NamespaceResolver {
    ...
    public void startElement(NodeName elemName, SchemaType typeCode, int locationId, int properties) throws XPathException {
        ...
        if ((properties & ReceiverOptions.REFUSE_NAMESPACES) != 0) {
            ...
            List<NamespaceBinding> undeclarations = new ArrayList<NamespaceBinding>(namespacesSize);
            ...
            pendingUndeclarations = undeclarations.toArray(new NamespaceBinding[undeclarations.size()]);
        } else {
