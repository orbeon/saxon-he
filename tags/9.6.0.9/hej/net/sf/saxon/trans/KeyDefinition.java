...
public class KeyDefinition extends ComponentBody {
    ...
    public void allocateAllBindingSlots(StylesheetPackage pack) {
        ...
        if (match instanceof PathFinder) {
            // TODO: avoid com.saxonica dependency
            allocateBindingSlotsRecursive(pack, this, ((PathFinder)match).getSelectionExpression());
        } else {
            allocateBindingSlotsRecursive(pack, this, new PatternSponsor((Pattern)match));
        }
    }
