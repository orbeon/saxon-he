...
public class Chain implements GroundedValue {
    ...
    public void append(Item item) {
        ...
        if (item != null) {
            if (item instanceof GroundedValue) {
                ...
                children.add(new One<Item>(item));
            }
        }
    }
    ...
    private class ChainIterator<T extends Item> implements UnfailingIterator, GroundedIterator {
        ...
        /*@NotNull*/
        public ChainIterator<Item> getAnother() {
            return new ChainIterator<Item>();
        }
