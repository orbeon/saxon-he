   ...
   /**
    ...
    public Object convertXPathValueToObject(Value value, cli.System.Type targetClass, XPathContext context) throws XPathException {
        ...
        if (isXmlNodeType(targetClass) &&
                ...
                ((SingletonItem)value).getItem() instanceof NodeWrapper) {
            return ((NodeWrapper)((SingletonItem)value).getItem()).getRealNode();
        } else if (isXdmAtomicValueType(targetClass)) {
            SequenceIterator atomIterator = Atomizer.getAtomizingIterator(value.iterate(context));
