...
// Revised 2008-09-08 by MHK to reuse the Templates object rather than the Transformer.
// Changes not yet tested or issued (2008-09-08).
...
public class AntTransform extends MatchingTask implements XSLTLogger {
    ...
    // TODO: setting this to true seems to cause files to be processed twice. Raised on dev@ant.apache.org
    ...
    public void execute() throws BuildException {
        ...
        if (schemaAware) {
            ...
            config = Configuration.makeLicensedConfiguration(null, null);
    ...
    private void process(File inFile, File outFile, Resource stylesheet)
        ...
        try {
            ...
            if (force || inFile.lastModified() >= outFile.lastModified()
                ...
                log("Processing (B) " + inFile + " to " + outFile,
                    Project.MSG_INFO);
                configureLiaison(stylesheet);
