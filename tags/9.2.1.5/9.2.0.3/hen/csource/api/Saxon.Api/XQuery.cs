...
using JValidation = net.sf.saxon.om.Validation;
...
namespace Saxon.Api
{
    ...
    public class XQueryCompiler
    {
        ...
        /// value is "1.0". This property must be set to "1.1" before compiling a query that
        /// uses XQuery 1.1 syntax.
        /// </summary>
        /// <remarks>
        /// <para>Support for XQuery 1.1 is currently limited: for details see the Saxon documentation.
        /// It cannot be used together with
        /// XQuery Updates. As well as enabling XQuery 1.1 via this API call, it must also be enabled
        /// by setting version="1.1" in the query prolog.</para>
        /// <para><i>Property added in Saxon 9.2</i></para></remarks>


        public string XQueryLanguageVersion
        {
            get { return env.getLanguageVersion(); }
            set { env.setLanguageVersion(value); }
        }

        /// <summary>
        /// The <c>SchemaAware</c> property determines whether the query is schema-aware. By default, a query
        /// is schema-aware if it contains one or more <code>import schema</code> declarations. This option allows
        /// a query to be marked as schema-aware even if it does not contain such a declaration. 
        /// </summary>
        /// <remarks>
        /// <para>If the query is not schema-aware, then schema-validated input documents will be rejected.</para>
        ...
        public bool SchemaAware
        {
            ...
            set
            {
                env.getExecutable().setSchemaAware(value);
            }
        }
