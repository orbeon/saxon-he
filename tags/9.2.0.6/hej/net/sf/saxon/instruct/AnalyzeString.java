...
public class AnalyzeString extends Instruction {
    ...
    protected void promoteInst(PromotionOffer offer) throws XPathException {
        ...
        regex = doPromotion(this, regex, offer);
        flags = doPromotion(this, flags, offer);
        if (matching != null) {
            matching = doPromotion(this, matching, offer);
        }
        if (nonMatching != null) {
            nonMatching = doPromotion(this, nonMatching, offer);
        }
    }
