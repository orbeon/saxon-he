...
public class XSLNamespace extends XSLLeafNodeConstructor {
    ...
    public void validate(ComponentDeclaration decl) throws XPathException {
        ...
        if (select == null) {
            if (countChildren == 0) {
                ...
                select = new StringLiteral(StringValue.EMPTY_STRING, this);
                ...
                if (firstChild.getNodeKind() == Type.TEXT) {
                    ...
                    select = new StringLiteral(firstChild.getStringValueCS(), this);
                    select.setContainer(this);
                }
            }
        }
    ...
    public Expression compile(Compilation exec, ComponentDeclaration decl) throws XPathException {
        ...
        compileContent(exec, decl, inst, new StringLiteral(StringValue.SINGLE_SPACE, this));
        return inst;
    }
