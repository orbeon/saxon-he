...
public class DocumentOverNodeInfo extends NodeOverNodeInfo implements Document {
     ...
     * @throws org.w3c.dom.DOMException INVALID_CHARACTER_ERR: Raised if the specified target contains an
     *                                  illegal character.
     ...
     *         <code>null</code> .
     * @throws org.w3c.dom.DOMException INVALID_CHARACTER_ERR: Raised if the specified name contains an
     *                                  illegal character.
     */
