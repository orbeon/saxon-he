        ...
        public Sequence call(XPathContext context, Sequence[] arguments /*@NotNull*/) throws XPathException {
            ...
            try {
                ...
                while (rs.next()) {                            // next row
                    ...
                    out.startElement(rowCode, Untyped.getInstance(), locationId, 0);
                    for (int col = 1; col <= icol; col++) {     // next column
                        ...
                        out.startElement(colName, Untyped.getInstance(), locationId, 0);
                        if (sqlName != null && !nameOK) {
                            out.attribute(new NoNamespaceName("name"), BuiltInAtomicType.UNTYPED_ATOMIC, sqlName, 0, 0);
                        }
                        if (result != null) {
