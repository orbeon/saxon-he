...
public class XPathFunctionLibrary implements FunctionLibrary {
    ...
    /*@Nullable*/
    public Expression bind(/*@NotNull*/ SymbolicName functionName, /*@NotNull*/  Expression[] staticArgs, StaticContext env, Container container)
...
//#ifdefined HOF
     ...
     *          that is private
     */
    public FunctionItem getFunctionItem(SymbolicName symbolicName, StaticContext staticContext, Container container) throws XPathException {
        if (resolver == null) {
            return null;
        }
        ...
        return new CallableFunctionItem(symbolicName, functionCall, functionType);
    }
//#endif
