...
public class BuiltInAtomicType implements AtomicType {
    ...
    public static BuiltInAtomicType NUMERIC =
            makeAtomicType(StandardNames.XS_NUMERIC, ANY_ATOMIC, true);
    ...
    public static BuiltInAtomicType DECIMAL =
            makeAtomicType(StandardNames.XS_DECIMAL, NUMERIC, true);

    public static BuiltInAtomicType FLOAT =
            makeAtomicType(StandardNames.XS_FLOAT, NUMERIC, true);

    public static BuiltInAtomicType DOUBLE =
            makeAtomicType(StandardNames.XS_DOUBLE, NUMERIC, true);
    ...
    /*@NotNull*/
    public final StructuredQName getQualifiedName() {
