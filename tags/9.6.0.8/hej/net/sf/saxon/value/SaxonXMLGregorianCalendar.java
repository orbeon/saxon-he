    ...
    public void setCalendarValue(/*@NotNull*/ CalendarValue value) {
        ...
        try {
            if (value instanceof GYearValue) {
                year = BigInteger.valueOf(((Int64Value) value.getComponent(AccessorFn.YEAR)).longValue());
            } else if (value instanceof GYearMonthValue) {
                year = BigInteger.valueOf(((Int64Value) value.getComponent(AccessorFn.YEAR)).longValue());
                month = (int) ((Int64Value) value.getComponent(AccessorFn.MONTH)).longValue();
            } else if (value instanceof GMonthValue) {
                month = (int) ((Int64Value) value.getComponent(AccessorFn.MONTH)).longValue();
            } else if (value instanceof GMonthDayValue) {
                month = (int) ((Int64Value) value.getComponent(AccessorFn.MONTH)).longValue();
                day = (int) ((Int64Value) value.getComponent(AccessorFn.DAY)).longValue();
                ...
                hour = (int) ((Int64Value) value.getComponent(AccessorFn.HOURS)).longValue();
                minute = (int) ((Int64Value) value.getComponent(AccessorFn.MINUTES)).longValue();
                second = (int) ((Int64Value) value.getComponent(AccessorFn.WHOLE_SECONDS)).longValue();
                microsecond = (int) ((Int64Value) value.getComponent(AccessorFn.MICROSECONDS)).longValue();
            } else {
                year = BigInteger.valueOf(((Int64Value) value.getComponent(AccessorFn.YEAR)).longValue());
                month = (int) ((Int64Value) value.getComponent(AccessorFn.MONTH)).longValue();
                day = (int) ((Int64Value) value.getComponent(AccessorFn.DAY)).longValue();
