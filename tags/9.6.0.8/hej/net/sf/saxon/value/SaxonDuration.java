...
public class SaxonDuration extends Duration {
    ...
    public Number getField(DatatypeConstants.Field field) {
        try {
            if (field == DatatypeConstants.YEARS) {
                return BigInteger.valueOf(((Int64Value) duration.getComponent(AccessorFn.YEAR)).longValue());
            } else if (field == DatatypeConstants.MONTHS) {
                return BigInteger.valueOf(((Int64Value) duration.getComponent(AccessorFn.MONTH)).longValue());
            } else if (field == DatatypeConstants.DAYS) {
                return BigInteger.valueOf(((Int64Value) duration.getComponent(AccessorFn.DAY)).longValue());
            } else if (field == DatatypeConstants.HOURS) {
                return BigInteger.valueOf(((Int64Value) duration.getComponent(AccessorFn.HOURS)).longValue());
            } else if (field == DatatypeConstants.MINUTES) {
                return BigInteger.valueOf(((Int64Value) duration.getComponent(AccessorFn.MINUTES)).longValue());
            } else if (field == DatatypeConstants.SECONDS) {
                return (((DecimalValue) duration.getComponent(AccessorFn.SECONDS)).getDecimalValue());
            } else {
    ...
    public void addTo(Calendar calendar) {
        ...
        try {
            ...
            calendar.add((int) ((Int64Value) duration.getComponent(AccessorFn.WHOLE_SECONDS)).longValue() * sign,
                    Calendar.SECOND);
            calendar.add((int) ((Int64Value) duration.getComponent(AccessorFn.MICROSECONDS)).longValue() * sign / 1000,
