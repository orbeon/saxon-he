...
public abstract class BinaryExpression extends Expression {
    ...
    public Iterable<Operand> operands() {
        return operandList(
                new Operand(operand0, OperandRole.SINGLE_ATOMIC),
                new Operand(operand1, OperandRole.SINGLE_ATOMIC));
    }
    ...
    public String toShortString() {
        return operand0.toShortString() + " " + displayOperator() + " " + operand1.toShortString();
    }
