...
public abstract class ElementCreator extends ParentNodeConstructor {
    ...
    public ItemType getItemType() {
        ...
        if (onEmpty == null) {
            ...
            return Type.getCommonSuperType(NodeKindTest.ELEMENT, onEmpty.getItemType(), th);
        }
    }
    ...
    public Iterable<Operand> operands() {
        if (onEmpty == null) {
            ...
            return operandList(
                    ...
                    new Operand(onEmpty, new OperandRole(0, OperandUsage.ABSORPTION, SequenceType.OPTIONAL_ELEMENT_NODE)));
        }
    }
    ...
    /**
     * Determine whether this element inherits namespaces from its parent. True except in XQuery where
    ...
    public final TailCall processLeavingTail(XPathContext context, /*@Nullable*/ NodeInfo copiedNode)
        ...
        try {
            ...
            if (onEmpty != null) {
                properties |= ReceiverOptions.IF_NOT_EMPTY;
            }
...
//#ifdefined STREAM
    ...
    public StreamingAdjunct getStreamingAdjunct() {
        return new ElementCreatorAdjunct();
    }
