...
public abstract class Assignation extends Expression implements LocalBinding {
    ...
    public Iterable<Operand> operands() {
        Operand sequenceInfo = new Operand(sequence, OperandRole.NAVIGATE);
        OperandRole actionRole = this instanceof LetExpression ? OperandRole.SAME_FOCUS_ACTION : REPEATED_ACTION_ROLE;
        Operand actionInfo = new Operand(action, actionRole);
        return operandList(sequenceInfo, actionInfo);
    }
    ...
    public void replaceVariable(Expression seq) throws XPathException {
        ExpressionTool.inlineVariableReferences(action, this, seq);
