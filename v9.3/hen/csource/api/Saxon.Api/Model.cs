...
namespace Saxon.Api
{
    ...
    public class XdmValue : IEnumerable
    {
        ...
        public static XdmValue Wrap(ValueRepresentation value)
        {
            ...
            {
                value = ((JSingletonItem)value).getItem();
                result = new XdmNode();
            }
            else
            {
    ...
    /// returned are always instances of <c>XPathItem</c>. In addition to the
    /// methods defined by IEnumerator, an additional method <c>GetAnother</c>
