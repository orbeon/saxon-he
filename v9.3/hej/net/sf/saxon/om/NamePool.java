...
public class NamePool implements Serializable {
    ...
    /**
     * Create a copy of this NamePool. All entries in this NamePool are copied to the new NamePool,
     * and the two NamePools therefore initially allocate the same codes to the same names. Subsequent
     * changes to either NamePool, however, will not be reflected in the other. This method should
     * therefore be used with great care, as misuse can easily lead to spurious matches or mismatches
     * between name codes.
     * @return a copy of this NamePool
     */

    public synchronized NamePool copy() {
        NamePool n = new NamePool();
...
//            URI u =new URI(uri);
//            if (!u.isAbsolute()) {
//                System.err.println("**** relative URI used as namespace: " + uri);
//            }
//        } catch (URISyntaxException err) {
//            System.err.println("**** illegal URI used as namespace: " + uri);
//        }
        uris[urisUsed] = uri;
        return urisUsed++;
    }
