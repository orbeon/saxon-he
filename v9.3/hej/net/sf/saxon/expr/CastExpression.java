    ...
    */
    ...
    public Item evaluateItem(XPathContext context) throws XPathException {
        ...
        if (upcast) {
            ...
            AtomicValue result = (AtomicValue)value.convert(targetPrimitiveType, false, rules);
            if (derived) {
                result = (AtomicValue)result.convert(targetType, false, rules);
            }
            return result;
        }
        ConversionResult result = value.convert(targetType, true, rules);
