...
/**
 * This interface is a dummy stub for the Java code generator in Saxon-EE. It is designed to enable
 * code to be shared between Saxon-HE and Saxon-EE without failing on Saxon-HE because the code generation
