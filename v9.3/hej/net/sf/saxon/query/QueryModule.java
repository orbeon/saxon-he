...
public class QueryModule implements StaticContext {
    ...
    private void initializeFunctionLibraries() {
...
//    }
    ...
    public void checkImportedType(SequenceType importedType, final Declaration declaration)
            throws XPathException {
    ...
    public NamespaceResolver getNamespaceResolver() {
        ...
        if (externalResolver != null) {
            ...
            while (iter.hasNext()) {
                ...
                int nscode = getNamePool().allocateNamespaceCode(prefix, uri);
                externalNamespaceCodes.add(Integer.valueOf(nscode));
            }
        }
        ...
        for (Map.Entry<String, String> e : userDeclaredNamespaces.entrySet()) {
            nscodes[used++] = namePool.getNamespaceCode(e.getKey(), e.getValue());
        }
