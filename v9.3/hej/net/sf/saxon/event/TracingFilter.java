...
public class TracingFilter extends ProxyReceiver {
     ...
     * trace messages
     * @param nextReceiever the underlying receiver to which the events will be sent
     * @param diagnosticOutput the destination for diagnostic trace messages
     */

    public TracingFilter(Receiver nextReceiever, PrintStream diagnosticOutput) {
        id = nextid++;
        out = diagnosticOutput;
        setUnderlyingReceiver(nextReceiever);
    }
    ...
    public void attribute(int nameCode, int typeCode, CharSequence value, int locationId, int properties) throws XPathException {
        out.println("RCVR " + id + indent + " ATTRIBUTE " + getNamePool().getDisplayName(nameCode));
    ...
    public void startElement(int nameCode, int typeCode, int locationId, int properties) throws XPathException {
        out.println("RCVR " + id + indent + " START ELEMENT " + getNamePool().getDisplayName(nameCode));
