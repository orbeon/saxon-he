...
public final class ComplexContentOutputter extends SequenceReceiver {
    ...
    throws XPathException {
        ...
        for (int i=0; i<pendingNSListSize; i++) {
            ...
            if ((nscode >>16) == (pendingNSList[i]>>16)) {
                if (pendingNSList[i] == 0 || nscode == 0) {
                    // xmlns="" overridden by xmlns="abc"
                    pendingNSList[i] = nscode;
                    ...
                    // TODO: XQuery error code looks wrong in spec
                    throw err;
                } else {
    ...
    */
    ...
    public void attribute(int nameCode, int typeCode, CharSequence value, int locationId, int properties) throws XPathException {
        ...
        if (level==0 && typeCode != StandardNames.XS_UNTYPED_ATOMIC && currentLevelIsDocument[0]) {
            SimpleType type = (SimpleType)getConfiguration().getSchemaType(typeCode & NamePool.FP_MASK);
