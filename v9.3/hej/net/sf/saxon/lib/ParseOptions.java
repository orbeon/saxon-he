...
public class ParseOptions implements Serializable {
    ...
    private List<ProxyReceiver> filters = null;
    ...
    public ParseOptions(ParseOptions p) {
        ...
        if (p.filters != null) {
            filters = new ArrayList<ProxyReceiver>(p.filters);
        }
    ...
    public void merge(ParseOptions options) {
        ...
        if (options.filters != null) {
            if (filters == null) {
                filters = new ArrayList<ProxyReceiver>();
            }
    ...
    public void addFilter(ProxyReceiver filter) {
        if (filters == null) {
            filters = new ArrayList<ProxyReceiver>(5);
        }
        filters.add(filter);
    }
    ...
    public List<ProxyReceiver> getFilters() {
        return filters;
    }
