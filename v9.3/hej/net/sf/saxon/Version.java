...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9,3,0,1};
    private static final String VERSION = "9.3.0.1";
    private static final String BUILD = "080500"; //mmddhh
    private static final String RELEASE_DATE = "2009-10-30";
    private static final String MAJOR_RELEASE_DATE = "2009-10-30";
