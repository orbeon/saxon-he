...
namespace TestRunner
{
    class FotsResultsDocument: ResultsDocument
    {
        ...
        public override void writeResultFilePreamble(Processor processor, XdmNode catalog) { 
            ...
            System.Collections.IEnumerator iter = catalog.EnumerateAxis(XdmAxis.Child, new QName(FOTestSuiteDriver.CNS, "catalog"));
            if (!iter.MoveNext()) {
                throw new Exception("Outermost element of catalog file must be Q{"+FOTestSuiteDriver.CNS+"}catalog");
            }
