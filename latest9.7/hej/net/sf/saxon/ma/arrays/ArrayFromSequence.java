...
public class ArrayFromSequence extends ExtensionFunctionDefinition {
    ...
    private final static StructuredQName name = new StructuredQName("array", NamespaceConstant.ARRAY_FUNCTIONS, "_from-sequence");
    ...
    public ExtensionFunctionCall makeCallExpression() {
        return new ExtensionFunctionCall() {
            public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {
                SimpleArrayItem resultArray = SimpleArrayItem.makeSimpleArrayItem(arguments[0].iterate());
                return resultArray;
            }
        };
    }
