 ...
 */
public class ArrayInsertBefore extends ExtensionFunctionDefinition{

    private final static StructuredQName name = new StructuredQName("array", NamespaceConstant.ARRAY_FUNCTIONS, "insert-before");
