 ...
 */
public class ArrayReverse extends ExtensionFunctionDefinition {

    private final static StructuredQName name = new StructuredQName("array", NamespaceConstant.ARRAY_FUNCTIONS, "reverse");
        ...
        return new ExtensionFunctionCall() {
            public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {
                ...
                for (i=0; i < array.size(); i++) {
                    list.add(array.get(array.size()-i-1));
                }
