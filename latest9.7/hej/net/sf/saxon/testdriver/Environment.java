...
public class Environment implements URIResolver {
    ...
    public static Environment processEnvironment(
        ...
        environment.xqueryCompiler.setLanguageVersion(driver.spec.version.equals("2.0") ? "1.0" : driver.spec.version);
        ...
        for (XdmItem stylesheet : xpc.evaluate("package[@role='secondary']", env)) {
            ...
            try {
                ...
                //e.printStackTrace();
                driver.println("**** failure while compiling environment-defined stylesheet package " + fileName + ": " + e.getMessage());
