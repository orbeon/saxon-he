...
public abstract class StandardNames {
    ...
    public static final int XSL_WHERE_POPULATED = XSL + 81;


    public static final int XSL_DEFAULT_COLLATION = XSL + 100;
    public static final int XSL_DEFAULT_MODE = XSL + 101;
    public static final int XSL_EXCLUDE_RESULT_PREFIXES = XSL + 102;
    public static final int XSL_EXPAND_TEXT = XSL + 103;
    public static final int XSL_EXTENSION_ELEMENT_PREFIXES = XSL + 104;
    public static final int XSL_INHERIT_NAMESPACES = XSL + 105;
