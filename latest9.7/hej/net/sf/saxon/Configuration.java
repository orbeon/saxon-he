...
//#endif
    ...
    public SystemFunctionLibrary makeSystemFunctionLibrary(int featureSet) {
        return new SystemFunctionLibrary(featureSet);
    }
...
//        }
    ...
    public XPathParser newExpressionParser(String language, boolean updating, int languageVersion) throws XPathException {
        if ("XQ".equals(language)) {
            if (updating) {
                ...
                // In Saxon-HE, ignore the request for a 3.0 or 3.1 parser
            ...
            if (languageVersion == 31 || languageVersion == 30 || languageVersion == 20) {
    ...
    /**
     * Factory method to make the AccumulatorManager, used for dynamic information
     * about the accumulators used in a particular transformation
     *
     * @return a new AccumulatorManager appropriate to this Configuration
     */
...
//    }
    ...
    public void setConfigurationProperty(String name, Object value) {
        ...
        if (booleanPropertyNames.contains(name)) {
            ...
            if (name.equals(FeatureKeys.XQUERY_ALLOW_UPDATE)) {
                ...
                XPathParser parser = new XPathParser();
                parser.setLanguage(XPathParser.SEQUENCE_TYPE, 30);
                try {
    ...
    public Object getConfigurationProperty(String name) {
        ...
        if (name.equals(FeatureKeys.COLLATION_URI_RESOLVER)) {
            ...
            return getDefaultXsltCompilerInfo().getXsltVersion();
