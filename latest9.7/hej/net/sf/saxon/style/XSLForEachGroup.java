...
public final class XSLForEachGroup extends StyleElement {
    ...
    public void prepareAttributes() throws XPathException {
        ...
        for (int a = 0; a < atts.getLength(); a++) {
            ...
            if (f.equals("select")) {
                ...
                groupBy = makeExpression(groupByAtt, a);
            } else if (f.equals("group-adjacent")) {
                groupAdjacentAtt = atts.getValue(a);
                groupAdjacent = makeExpression(groupAdjacentAtt, a);
    ...
    public void validate(ComponentDeclaration decl) throws XPathException {
        ...
        if ((starting != null || ending != null) && visitor.getStaticContext().getXPathVersion() < 30) {   //TODO: check this condition
            try {
                RoleDiagnostic role =
