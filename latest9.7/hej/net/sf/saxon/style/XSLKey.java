...
public class XSLKey extends StyleElement implements StylesheetComponent {
     ...
     * StylesheetProcedure
     */
    public ComponentCode getCompiledProcedure() {
            ...
            if ("".equals(uri)) {
                if (local.equals("name")) {
                    ...
                    if (!isXslt30Processor()) {
                        compileErrorInAttribute("The 'composite' attribute requires XSLT 3.0", "XTSE0020", "composite");
                    }
    ...
    public void validate(ComponentDeclaration decl) throws XPathException {
        ...
        if (use != null) {
            use = use.typeCheck(makeExpressionVisitor(), new ContextItemStaticInfo(match.getItemType(), false));
        }
