...
public interface Platform {
    ...
    StringCollator makeICUCollator(String uri, Configuration config)  throws XPathException;
    ...
    RegularExpression compileRegularExpression(CharSequence regex, String flags, String hostLanguage, List<String> warnings)
