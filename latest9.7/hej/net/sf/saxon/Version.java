...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9, 7, 0, 8};
    private static final String VERSION = "9.7.0.8";
    private static final String BUILD = "090116"; //mmddhh
    private static final String RELEASE_DATE = "2016-09-01";
