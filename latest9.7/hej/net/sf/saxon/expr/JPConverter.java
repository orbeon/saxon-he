...
//#if EE==true||PE==true
        converterMap.put(Map.class, FromMap.INSTANCE);
//#endif
    ...
    static {
        ...
        itemTypeMap.put(DecimalValue.class, BuiltInAtomicType.DECIMAL);
...
//#endif
    ...
    public static JPConverter allocate(Class javaClass, java.lang.reflect.Type genericType, Configuration config) {
        ...
        return new ExternalObjectWrapper(new JavaExternalObjectType(javaClass, config));
    }
    ...
    public static class FromBigDecimal extends JPConverter {
        ...
        public DecimalValue convert(Object object, XPathContext context) throws XPathException {
    ...
    public static class ExternalObjectWrapper extends JPConverter {
        ...
        public static final ExternalObjectWrapper INSTANCE = new ExternalObjectWrapper(new JavaExternalObjectType(Object.class));
    ...
    public static class FromMap extends JPConverter {
        ...
        public MapItem convert(Object object, XPathContext context) throws XPathException {
            Map<Object, Object> jMap = (Map<Object, Object>) object;
            final Configuration config = context.getConfiguration();
            HashTrieMap pMap = new HashTrieMap(context);
            for (Map.Entry<Object, Object> entry : jMap.entrySet()) {
                Object key = entry.getKey();
                Object value = entry.getValue();
                JPConverter keyConverter = allocate(key.getClass(), null, config);
                JPConverter valueConverter = allocate(value.getClass(), null, config);
                try {
                    ...
                    if (keyItem instanceof AtomicValue && keyValue != null) {
                        pMap.initialPut((AtomicValue) keyItem, keyValue);
                    }
                } catch (XPathException e) {
                    throw new XPathException(
