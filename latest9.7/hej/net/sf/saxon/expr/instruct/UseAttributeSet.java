...
public class UseAttributeSet extends Instruction implements ComponentInvocation, ContextOriginator {
    ...
    public static Expression makeCompositeExpression(List<UseAttributeSet> targets) {
        if (targets.size() == 0) {
            ...
            return new Block(targets.toArray(new Expression[targets.size()]));
        }
    }
    ...
    public TailCall processLeavingTail(XPathContext context) throws XPathException {
        ...
        AttributeSet as = (AttributeSet) target.getCode();
...
//#ifdefined BYTECODE
    ...
    public ExpressionCompiler getExpressionCompiler() {
        return new UseAttributeSetCompiler();
    }
//#endif
...
//#ifdefined STREAM
    ...
    protected StreamingAdjunct getStreamingAdjunct() {
        return new UseAttributeSetAdjunct();
    }
//#endif
}
