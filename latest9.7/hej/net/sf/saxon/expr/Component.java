...
public class Component<T extends ComponentCode> {
     ...
     * Create a component
     *
     * @param code             the compiled code that implements the component, for example a Template or Function
    ...
    public void export(ExpressionPresenter out, Map<Component, Integer> componentIdMap) throws XPathException {
        ...
        String refs = listComponentReferences(componentIdMap).toString();
