...
//                            }
                    ...
                    if (schemaType == null) {
                        ...
                        itemType = new CombinedNodeTest(
                                test,
                                Token.INTERSECT,
                                new ContentTypeTest(Type.ELEMENT, schemaType, getConfiguration(), true));
                        ...
                        if (computedCardinality == StaticProperty.ALLOWS_ZERO) {
                            ...
                            visitor.issueWarning("The complex type " + contentType.getDescription() +
                                    " appears not to allow a child element named " + getDiagnosticName(childElement, env), getLocation());
                            return Literal.makeEmptySequence();
                        }
