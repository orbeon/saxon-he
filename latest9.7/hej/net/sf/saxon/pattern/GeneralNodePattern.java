...
public final class GeneralNodePattern extends Pattern {
    ...
    public Pattern typeCheck(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        equivalentExpr = equivalentExpr.typeCheck(visitor, ContextItemStaticInfo.DEFAULT);
        return this;
    }
    ...
    public Pattern optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextInfo) throws XPathException {
        equivalentExpr = equivalentExpr.optimize(visitor, ContextItemStaticInfo.DEFAULT);
        ...
        if (equivalentExpr instanceof FilterExpression && !((FilterExpression) equivalentExpr).isFilterIsPositional()) {
            try {
                return PatternMaker.fromExpression(equivalentExpr, getConfiguration(), true)
                    .typeCheck(visitor, ContextItemStaticInfo.DEFAULT);
    ...
    public void promote(PromotionOffer offer, Expression parent) throws XPathException {
        ...
        equivalentExpr = equivalentExpr.promote(offer);
