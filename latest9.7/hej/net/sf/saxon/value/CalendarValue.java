...
//    }
    ...
    /**
     * Get a value whose equals() method follows the "same key" rules for comparing the keys of a map. These are
     * essentially the same as the XSD rules for comparing date/time values for equality
     *
