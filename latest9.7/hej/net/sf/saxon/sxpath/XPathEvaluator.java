...
public class XPathEvaluator {
    ...
    public XPathExpression createExpression(String expression) throws XPathException {
        ...
        if (staticContext.getXPathVersion() >= 31) {
            permittedFunctions |= StandardFunction.XPATH31;
        }
        lib.addFunctionLibrary(
                SystemFunctionLibrary.getSystemFunctionLibrary(permittedFunctions, config));
