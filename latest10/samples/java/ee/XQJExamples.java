...
package ee;
import he.ExampleContentHandler;
...
/**
 * Some examples to illustrate the use of the XQJ XQuery API.
 * The tests should be run with the samples directory (in the saxon-resources download) as the
 * current directory.
 */
public class XQJExamples {
    ...
    /**
     * Show a query producing a document as its output, which is then read using a StAX client.
     * This is designed explicitly to demonstrate that element names and namespaces are available
     * at end-element time.
     */
