...
public class Query {
    ...
    protected void doQuery(String args[], String name) {
        ...
        try {
            ...
            while (i < args.length) {
                ...
                if (args[i].charAt(0) == '-') {
                    ...
                    if (args[i].equals("-cr")) {
                        ...
                        i++;
                        repeat = 9;
                    } else if (args[i].equals("-100")) {    // undocumented option: do it 100 times, report average
                        i++;
                        repeat = 100;
            ...
            if (explain) {
                staticEnv.getExecutable().getKeyManager().explainKeys(config, System.err);
                staticEnv.explainGlobalVariables(System.err);
                staticEnv.explainGlobalFunctions(System.err);
                exp.explain(staticEnv.getConfiguration(), System.err);
            }
            ...
            if (showTime && repeat == 100) {
                System.err.println("Average execution time: " + (totalTime/(double)r) + " milliseconds");
            }
    ...
    protected void badUsage(String name, String message) {
        ...
        System.err.println("  -xi             Expand XInclude on all documents");
