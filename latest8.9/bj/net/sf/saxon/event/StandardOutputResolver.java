...
public class StandardOutputResolver implements OutputURIResolver {
    ...
    /**
    * Guard low level I/O functions. (In particular, this wraps a semaphore around the
    * code that tests whether a directory exists before creating it.)
    */

    private static Object ioGuard = new Object();
