...
//    private NamePool pool;
        ...
        for (int i=0; i<pendingNSListSize; i++) {
        	...
        	if ((nscode>>16) == (pendingNSList[i]>>16)) {
        	    if (rejectDuplicates) {
                    ...
                    String uri1 = getNamePool().getURIFromNamespaceCode(nscode);
                    String uri2 = getNamePool().getURIFromNamespaceCode(pendingNSList[i]);
    ...
    * Append an arbitrary item (node or atomic value) to the output
     ...
     * need to be copied. Values are {@link NodeInfo#ALL_NAMESPACES}, {@link NodeInfo#LOCAL_NAMESPACES},
     * {@link NodeInfo#NO_NAMESPACES}
     */
