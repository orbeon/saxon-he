...
public class GYearValue extends GDateValue {
    ...
    public GYearValue(CharSequence value) throws XPathException {
        ...
        this.typeLabel = BuiltInAtomicType.G_YEAR;
    }
    ...
    */
    ...
    public CalendarValue add(DurationValue duration) throws XPathException {
        DynamicError err = new DynamicError("Cannot add a duration to an xs:gYear");
        err.setErrorCode("XPTY0004");
        throw err;
    }
    ...
    public CalendarValue adjustTimezone(int tz) {
        throw new UnsupportedOperationException("Cannot adjust timezone on an xs:gYear");
    }
}
