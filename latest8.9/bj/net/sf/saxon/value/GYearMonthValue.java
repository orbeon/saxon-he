...
public class GYearMonthValue extends GDateValue {
    ...
    public GYearMonthValue(CharSequence value) throws XPathException {
        ...
        this.typeLabel = BuiltInAtomicType.G_YEAR_MONTH;
    }
    ...
    */
    ...
    public CalendarValue add(DurationValue duration) throws XPathException {
        DynamicError err = new DynamicError("Cannot add a duration to an xs:gYearMonth");
        err.setErrorCode("XPTY0004");
        throw err;
    }
    ...
    public CalendarValue adjustTimezone(int tz) {
        throw new UnsupportedOperationException("Cannot adjust timezone on an xs:gYearMonth");
    }
}
