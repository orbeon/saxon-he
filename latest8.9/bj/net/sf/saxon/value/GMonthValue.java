...
public class GMonthValue extends GDateValue {
    ...
    public GMonthValue(CharSequence value) throws XPathException {
        ...
        this.typeLabel = BuiltInAtomicType.G_MONTH;
    }
    ...
    */
    ...
    public CalendarValue add(DurationValue duration) throws XPathException {
        DynamicError err = new DynamicError("Cannot add a duration to an xs:gMonth");
        err.setErrorCode("XPTY0004");
        throw err;
    }
    ...
    public CalendarValue adjustTimezone(int tz) {
        throw new UnsupportedOperationException("Cannot adjust timezone on an xs:gMonth");
    }
}
