...
public class GDayValue extends GDateValue {
    ...
    public GDayValue(CharSequence value) throws XPathException {
        ...
        this.typeLabel = BuiltInAtomicType.G_DAY;
    }
    ...
    */
    ...
    public CalendarValue add(DurationValue duration) throws XPathException {
        DynamicError err = new DynamicError("Cannot add a duration to an xs:gDay");
        err.setErrorCode("XPTY0004");
        throw err;
    }
    ...
    public CalendarValue adjustTimezone(int tz) {
        throw new UnsupportedOperationException("Cannot adjust timezone on an xs:gDay");
    }
}
