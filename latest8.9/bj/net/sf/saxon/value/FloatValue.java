...
public final class FloatValue extends NumericValue {
    ...
    */
    ...
    public NumericValue roundHalfToEven(int scale) {
        try {
            return (FloatValue)
                    new DoubleValue((double)value).roundHalfToEven(scale).convert(BuiltInAtomicType.FLOAT, null);
    ...
    */
        ...
        if (other instanceof FloatValue) {
            switch(operator) {
                ...
                case Token.IDIV:
                    ...
                    return (NumericValue)
                            new FloatValue(value / ((FloatValue) other).value).convert(BuiltInAtomicType.INTEGER, context);
                case Token.MOD:
                    return new FloatValue(value % ((FloatValue)other).value);
                default:
            ...
            return ((DoubleValue)convert(BuiltInAtomicType.DOUBLE, context)).arithmetic(operator, other, context);
        } else {
            return arithmetic(operator, (FloatValue)other.convert(BuiltInAtomicType.FLOAT, context), context);
        }
    }
    ...
    public int compareTo(Object other) {
        ...
        try {
            return compareTo(((NumericValue)other).convert(BuiltInAtomicType.FLOAT, null));
        } catch (XPathException err) {
