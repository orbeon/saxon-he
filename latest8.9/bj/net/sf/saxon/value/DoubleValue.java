    ...
    public AtomicValue convertPrimitive(BuiltInAtomicType requiredType, boolean validate, XPathContext context) {
        ...
        case Type.INTEGER:
            ...
            if (Double.isInfinite(value)) {
                ValidationException err = new ValidationException("Cannot convert double INF to an integer");
        ...
        if (other instanceof DoubleValue) {
            switch(operator) {
                ...
                case Token.IDIV:
                    ...
                    return (NumericValue)(new DoubleValue(value /
                            ((DoubleValue)other).value).convert(BuiltInAtomicType.INTEGER, context));
                case Token.MOD:
                    return new DoubleValue(value % ((DoubleValue)other).value);
                default:
            ...
            return arithmetic(operator, (DoubleValue)other.convert(BuiltInAtomicType.DOUBLE, context), context);
        }
    }
