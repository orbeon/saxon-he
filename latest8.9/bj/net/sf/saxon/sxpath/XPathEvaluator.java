...
public class XPathEvaluator {
    ...
    * removed. This affects the action of the {@link #build} method.
    ...
    */
    ...
    public XPathVariable declareVariable(String uri, String localName) {
        return staticContext.declareVariable(new QNameValue("", uri, localName));
    }
    ...
    */
    ...
    public XPathExpression createExpression(String expression) throws XPathException {
        ...
        exp.setParentExpression(staticContext);
