...
public class BuiltInListType implements ListType, Serializable {
    ...
    public static void init() {
        ...
        String XS = NamespaceConstant.SCHEMA;
        String XSI = NamespaceConstant.SCHEMA_INSTANCE;
        ENTITIES = makeListType(XS, "NMTOKENS");
        IDREFS = makeListType(XS, "IDREFS");
        NMTOKENS = makeListType(XS, "ENTITIES");
        ANY_URIS = makeListType(XSI, "anonymous_schemaLocationType");
    }
