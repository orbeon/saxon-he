...
public interface AtomicType extends SimpleType, ItemType {
     ...
     *        <p><b>The type label of this value will be changed. A caller must therefore be absolutely sure
     *        that they have exclusive use of the object. If in doubt, call the copy() method first.</b></p>
