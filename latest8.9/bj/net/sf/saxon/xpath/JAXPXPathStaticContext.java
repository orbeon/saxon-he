...
public class JAXPXPathStaticContext extends AbstractStaticContext
    ...
    */
     ...
     * the API.
     *
     * @throws StaticError if no VariableResolver has been supplied.
     */

    public final VariableReference bindVariable(int fingerprint) throws StaticError {
        ...
        if (variableResolver != null) {
            QNameValue qname = new QNameValue(getNamePool(), fingerprint);
