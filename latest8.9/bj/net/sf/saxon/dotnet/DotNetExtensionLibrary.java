...
//                }
    ...
    protected int atomicConversionPreference(int primitiveType, cli.System.Type required) {
        ...
        switch (primitiveType) {
            case Type.STRING:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.StringValue"))) return 50;
                ...
                return -1;
            case Type.DOUBLE:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.DoubleValue"))) return 50;
                if (required == DotNetExtensionFunctionCall.CLI_DOUBLE) return 51;
                return -1;
            case Type.FLOAT:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.FloatValue"))) return 50;
                if (required == DotNetExtensionFunctionCall.CLI_SINGLE) return 51;
                if (required == DotNetExtensionFunctionCall.CLI_DOUBLE) return 52;
                return -1;
            case Type.DECIMAL:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.DecimalValue"))) return 50;
                ...
                return -1;
            case Type.INTEGER:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.IntegerValue"))) return 50;
                if (required == DotNetExtensionFunctionCall.CLI_DECIMAL) return 51;
            ...
            case Type.BOOLEAN:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.BooleanValue"))) return 50;
            ...
            case Type.G_YEAR:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.DateValue"))) return 50;
                if (required == cli.System.Type.GetType("System.DateTime")) return 51;
                return -1;
            case Type.DATE_TIME:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.DateTimeValue"))) return 50;
                if (required == cli.System.Type.GetType("System.DateTime")) return 51;
                return -1;
            case Type.TIME:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.TimeValue"))) return 50;
                if (required == cli.System.Type.GetType("System.DateTime")) return 51;
                return -1;
            case Type.DURATION:
            case Type.YEAR_MONTH_DURATION:
            case Type.DAY_TIME_DURATION:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.DurationValue"))) return 50;
                return -1;
            case Type.ANY_URI:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.AnyURIValue"))) return 50;
                if (required == cli.System.Type.GetType("System.Uri")) return 51;
                if (required == DotNetExtensionFunctionCall.CLI_STRING) return 52;
                return -1;
            case Type.QNAME:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.QNameValue"))) return 50;
                if (required == cli.System.Type.GetType("System.Xml.XmlQualifiedName")) return 51;
                return -1;
            case Type.BASE64_BINARY:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.Base64BinaryValue"))) return 50;
                return -1;
            case Type.HEX_BINARY:
                if (required.IsAssignableFrom(cli.System.Type.GetType("net.sf.saxon.HexBinaryValue"))) return 50;
                return -1;
    ...
    private cli.System.Type getExternalDotNetType(String uri) {
        ...
        try {
            ...
            if (uri.startsWith("clitype:")) {
                return ((DotNetPlatform)Configuration.getPlatform()).dynamicLoad(uri, config.isTraceExternalFunctions());
            }
    ...
    private class UnresolvedExtensionFunction extends CompileTimeFunction {
        ...
        public Expression typeCheck(StaticContext env, ItemType contextItemType) throws XPathException {
            ...
            if (method == null) {
                ...
                call.setLocationId(getLocationId());
                call.setParentExpression(getParentExpression());
                return call;
            }
        }
    }
