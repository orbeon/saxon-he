...
public abstract class Instruction extends Expression implements SourceLocator, TailCallReturner {
    ...
    */
    ...
    protected static DynamicError dynamicError(SourceLocator loc, XPathException error, XPathContext context) {
        if (error instanceof TerminationException) {
            return (TerminationException)error;
        }
        if (error.getLocator()==null ||
            ...
            try {
                ...
                return DynamicError.makeDynamicError(error);
            }
        }
        return DynamicError.makeDynamicError(error);
    }
