...
public class AnalyzeString extends Instruction {
    ...
    public Expression typeCheck(StaticContext env, ItemType contextItemType) throws XPathException {
        ...
        if (matching != null) {
            matching = matching.typeCheck(env, BuiltInAtomicType.STRING);
            adoptChildExpression(matching);
        }
        if (nonMatching != null) {
            nonMatching = nonMatching.typeCheck(env, BuiltInAtomicType.STRING);
    ...
    public Expression optimize(Optimizer opt, StaticContext env, ItemType contextItemType) throws XPathException {
        ...
        adoptChildExpression(flags);
        if (matching != null) {
            matching = matching.optimize(opt, env, BuiltInAtomicType.STRING);
            adoptChildExpression(matching);
        }
        if (nonMatching != null) {
            nonMatching = nonMatching.optimize(opt, env, BuiltInAtomicType.STRING);
            adoptChildExpression(nonMatching);
        }
        return this;
    }
