    ...
    public static void serializeSequence(SequenceIterator results, Configuration config,
        ...
        while (true) {
            ...
            if (item instanceof NodeInfo) {
                ...
                case Type.DOCUMENT:
                case Type.ELEMENT:
                    serialize((NodeInfo)item, new StreamResult(writer), outputProps);
                    writer.println("");
                    break;
                case Type.ATTRIBUTE:
            ...
            } else if (item instanceof QualifiedNameValue) {
                writer.println(((QualifiedNameValue)item).getClarkName());
            } else {
                writer.println(item.getStringValue());
            }
        }
