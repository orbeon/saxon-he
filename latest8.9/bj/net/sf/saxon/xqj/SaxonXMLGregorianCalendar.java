    ...
    public void setCalendarValue(CalendarValue value) {
        try {
            if (value instanceof GYearValue) {
                this.year = BigInteger.valueOf(((Int64Value)value.getComponent(Component.YEAR)).longValue());
            } else if (value instanceof GYearMonthValue) {
                this.year = BigInteger.valueOf(((Int64Value)value.getComponent(Component.YEAR)).longValue());
                this.month = (int)((Int64Value)value.getComponent(Component.MONTH)).longValue();
            } else if (value instanceof GMonthValue) {
                this.month = (int)((Int64Value)value.getComponent(Component.MONTH)).longValue();
            } else if (value instanceof GMonthDayValue) {
                this.month = (int)((Int64Value)value.getComponent(Component.MONTH)).longValue();
                this.day = (int)((Int64Value)value.getComponent(Component.DAY)).longValue();
                ...
                this.hour = (int)((Int64Value)value.getComponent(Component.HOURS)).longValue();
                this.minute = (int)((Int64Value)value.getComponent(Component.MINUTES)).longValue();
                this.second = (int)((Int64Value)value.getComponent(Component.WHOLE_SECONDS)).longValue();
                this.microsecond = (int)((Int64Value)value.getComponent(Component.MICROSECONDS)).longValue();
            } else {
                this.year = BigInteger.valueOf(((Int64Value)value.getComponent(Component.YEAR)).longValue());
                this.month = (int)((Int64Value)value.getComponent(Component.MONTH)).longValue();
                this.day = (int)((Int64Value)value.getComponent(Component.DAY)).longValue();
