...
public class AlphanumericComparer implements StringCollator, java.io.Serializable {

    private StringCollator baseComparer;
    ...
    */
    ...
    public int compareStrings(String s1, String s2) {
        ...
        while (true) {
            ...
            int c = baseComparer.compareStrings(s1.substring(pos1, m1start), s2.substring(pos2, m2start));
            if (c != 0) {
                return c;
            }
