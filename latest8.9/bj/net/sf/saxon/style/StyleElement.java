    ...
    public SchemaType getSchemaType(String typeAtt) throws XPathException {
        try {
            ...
            if ("".equals(parts[0])) {
                ...
                nameCode = getTargetNamePool().allocate(parts[0], uri, lname);
            } else {
...
//            }
    ...
    public Expression typeCheck(String name, Expression exp) throws XPathException {
        ...
        Expression.setParentExpression(exp, this);
        ...
        try {
            ...
            if (pattern instanceof LocationPathPattern) {
                ...
                if (usesCurrent) {
                    ...
                    let.setAction(Literal.makeLiteral(EmptySequence.getInstance()));
...
//    }
    ...
    public Expression compileSequenceConstructor(Executable exec, AxisIterator iter, boolean includeParams)
        ...
        Expression result = Literal.makeLiteral(EmptySequence.getInstance());
