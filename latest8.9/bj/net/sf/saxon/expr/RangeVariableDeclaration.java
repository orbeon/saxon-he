    ...
    public boolean allReferencesAreAtomized() {
        for (int i=references.size()-1; i>=0; i--) {
            ...
            if (bref instanceof VariableReference) {
                ...
                if (parent instanceof SimpleContentConstructor ||
                        parent instanceof Atomizer ||
                        parent instanceof StringFn) {
            ...
            if (bref instanceof VariableReference) {
                ...
                while (true) {
                    ...
                    if (parent instanceof Expression) {
                        ...
                        } else if (ExpressionTool.isRepeatedSubexpression((Expression)parent, child, env)) {
                            rcount += 10;
                            break;
                        } else  {
