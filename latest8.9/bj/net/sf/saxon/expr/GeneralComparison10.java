    ...
    */
    ...
    protected static boolean compare(AtomicValue a0,
        ...
        if (t0.equals(BuiltInAtomicType.STRING) || t1.equals(BuiltInAtomicType.STRING) ||
            ...
            StringValue s0 = (StringValue)a0.convert(BuiltInAtomicType.STRING, context);
            StringValue s1 = (StringValue)a1.convert(BuiltInAtomicType.STRING, context);
        ...
        if (t0.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a0 = a0.convertPrimitive(t1, true, context);
        ...
        if (t1.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a1 = a1.convertPrimitive(t0, true, context);
