 ...
 * standard Ant xslt task, and makes heavy reuse of its code.
 *
 */
...
public class AntTransform extends MatchingTask implements XSLTLogger {
    ...
    /**
     * Whether validation is strict, lax, or skip
     */

    private String validation = "skip";
    ...
    public void execute() throws BuildException {
        ...
        if ("skip".equals(validation)) {
            factory.getConfiguration().setSchemaValidationMode(Validation.SKIP);
        } else if ("strict".equals(validation)) {
            factory.getConfiguration().setSchemaValidationMode(Validation.STRICT);
        } else if ("lax".equals(validation)) {
            factory.getConfiguration().setSchemaValidationMode(Validation.LAX);
        } else {
    ...
    protected void configureLiaison(Resource stylesheet) throws BuildException {
        ...
        try {
            ...
            if (stylesheet instanceof FileResource) {
                ...
                Templates t = factory.newTemplates(new StreamSource(styleFile));
