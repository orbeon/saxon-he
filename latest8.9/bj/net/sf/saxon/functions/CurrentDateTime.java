...
public class CurrentDateTime extends SystemFunction {
    ...
    */
    ...
    public Item evaluateItem(XPathContext context) throws XPathException {
        ...
        switch (targetType) {
            case Type.DATE_TIME:
                return dt;
            case Type.DATE:
                return (DateValue)dt.convert(BuiltInAtomicType.DATE, context);
            case Type.TIME:
                return (TimeValue)dt.convert(BuiltInAtomicType.TIME, context);
    ...
    public static DayTimeDurationValue getImplicitTimezone(XPathContext context) throws XPathException {
        DateTimeValue dt = DateTimeValue.getCurrentDateTime(context);
        return (DayTimeDurationValue)dt.getComponent(Component.TIMEZONE);
    }
