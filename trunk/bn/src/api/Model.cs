...
using JStandardNames = net.sf.saxon.style.StandardNames;
...
namespace Saxon.Api {
    ...
    /// </summary>
    /// <remarks>
    /// <para>An <c>XPathValue</c> is immutable.</para>
    /// <para>A sequence consisting of a single item <i>may</i> be represented
    /// as an instance of <c>XPathItem</c>, which is a subtype of <c>XPathValue</c>.</para>
    /// </remarks>
    ...
    public class XdmValue : IEnumerable {
        ...
        public IEnumerator GetEnumerator() {
            if (value == null) {
                ...
                return new SequenceEnumerator(((Value)value).iterate(null));
            }
        }
    ...
    public sealed class QName {
        ...
        private static String XDT = NamespaceConstant.XDT;
        ...
        /// <summary>QName constant for the name xdt:untypedAtomic</summary>
        public static readonly QName XDT_UNTYPED_ATOMIC = new QName(XDT, "xdt:untypedAtomic");
