...
public class StartTagBuffer extends ProxyReceiver implements NamespaceResolver
{
    ...
    // TODO: the StartTagBuffer only knows about explicitly-generated namespace declarations, not
    // namespace declarations generated by namespace fixup, which are handled further down the pipeline.
    // This means that QName-valued attributes such as xsi:type are rejected if they depend on a namespace
    // that comes only from namespace fixup.
    // See test qischema064, removing the xmlns:z="uri". (Seems OK in XSLT, see schema092/3)
    ...
    */
    ...
    public void startContent() throws XPathException {
        nextReceiver.startElement(elementNameCode, elementTypeCode, elementLocationId, elementProperties);
