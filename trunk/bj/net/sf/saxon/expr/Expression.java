...
public interface Expression extends Serializable {
    ...
    /**
     * Simplify an expression. This performs the first phase static optimization (by rewriting the expression
     * as a different expression). The default implementation does nothing.
     * @param env the static context
     * @exception net.sf.saxon.trans.StaticError if an error is discovered during expression
     *     rewriting
     * @return the simplified expression. If this is a different expression from the original, the
     * implementation is responsible for setting up (a) the location information in the new expression,
     * and (b) its parent pointer in the expression tree [which can generally be initialized using
     * getParentExpression()]
     */
    ...
    Expression typeCheck(StaticContext env, ItemType contextItemType) throws XPathException;
    ...
    Expression optimize(Optimizer opt, StaticContext env, ItemType contextItemType) throws XPathException;
     ...
     *
     * @param context The context in which the expression is to be evaluated. Note that this
   ...
   /**
    ...
    /**
     * Evaluate the expression in "push" mode: the results of evaluating the expression are
     * sent to the {@link net.sf.saxon.event.Receiver} registered as part of the supplied context.
     * @param context The context in which the expression is to be evaluated. Note that this
     * context must contain a stackframe with sufficient slots to allow evaluation of any
     * variables contained in the expression (including variables allocated internally
     * by the optimizer)
