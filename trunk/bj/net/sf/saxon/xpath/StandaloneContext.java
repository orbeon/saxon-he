...
public class StandaloneContext implements StaticContext, NamespaceResolver {
    ...
    */
    ...
    public Variable declareVariable(String qname, Object initialValue) throws XPathException {
        ...
        QNameValue q = new QNameValue(prefix, uri, localName, null);
    ...
    */
    ...
    public void importSchema(Source source) throws SchemaException {
        config.addSchemaSource(source, config.getErrorListener());
    }
    ...
    public boolean isImportedSchema(String namespace) {
        return config.isSchemaAvailable(namespace);
    }
    ...
    public Set getImportedSchemaNamespaces() {
        return config.getImportedNamespaces();
    }
