    ...
    */
    ...
    public void copy(Receiver out, int whichNamespaces, boolean copyAnnotations, int locationId) throws XPathException {
        ...
        for (int i=0; i<attributeList.getLength(); i++) {
            out.attribute(attributeList.getNameCode(i), StandardNames.XDT_UNTYPED_ATOMIC,
        ...
        while (next!=null) {
            // TODO: detect CopyNamespaceSensitiveException (currently done only for TinyTree)
