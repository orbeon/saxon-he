...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9, 8, 0, 9};
    private static final String VERSION = "9.8.0.9";
    private static final String BUILD = "021010"; //mmddhh
    private static final String RELEASE_DATE = "2018-02-10"; //yyy-mm-dd
