...
//        }
    ...
    public final RetainedStaticContext getRetainedStaticContext() {
        if (retainedStaticContext == null) {
            ...
            return parent == null ? null : parent.getRetainedStaticContext();
            //setRetainedStaticContextLocally(parent == null ? null : parent.getRetainedStaticContext());
        }
    ...
    /**
     * Ask whether this expression is a call on a particular function
     * @param localName the name of the function in question, in the standard fn namespace
     */
