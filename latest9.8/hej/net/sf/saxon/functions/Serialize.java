...
public class Serialize extends SystemFunction implements Callable {
    ...
    private String[] paramNamesSaxon = new String[]{
            ...
            /*"next-in-chain",*/ "recognize-binary", "require-well-formed", "single-quotes",
    ...
    private Properties setSerializationParams(Properties props, Map<String, Sequence> map,
                                              CharacterMapIndex charMapIndex, XPathContext context) throws XPathException {
        Sequence seqVal;
    ...
    private StringValue evalSerialize(SequenceIterator iter, /*@Nullable*/ Item param, XPathContext context) throws XPathException {
        ...
        if (param != null) {
            if (param instanceof NodeInfo) {
                ...
                props = setSerializationParams(props, checkedOptions, charMapIndex, context);
            } else {
