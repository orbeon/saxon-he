        ...
        for (int a = 0; a < atts.getLength(); a++) {
            ...
            if (f.equals("name")) {
                ...
                try {
                    ...
                    compileError(new XPathException(e));
    ...
    public void compileDeclaration(Compilation compilation, ComponentDeclaration decl) throws XPathException {
        ...
        while ((curr = kids.next()) != null) {
            if (curr instanceof XSLAccumulatorRule) {
                ...
                AccumulatorRule action = new AccumulatorRule(newValueExp, stackFrameMap);
    ...
    private void checkInitialStreamability(Expression init) throws XPathException {
        ...
        if (accumulator.isDeclaredStreamable()) {
            ...
            if (ps.getSweep() != Sweep.MOTIONLESS) {
                compileError("The initial value expression for a streaming accumulator must be motionless", "XTSE3430");
            }
        }
