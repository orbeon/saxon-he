    ...
    public void prepareAttributes() throws XPathException {
        ...
        for (int a = 0; a < atts.getLength(); a++) {
            ...
            if (f.equals("name")) {
                ...
                String outputVersion = Whitespace.trim(atts.getValue(a));
        ...
        try {
            if (isListOfNames(property)) {
                ...
                value = SaxonOutputKeys.parseListOfNodeNames(
                        value, this, useDefaultNS, false, "XTSE0280");
            }
            if (isQName(property) && value.contains(":")) {
                value = ResolveQName.resolveQName(value, this).getClarkName();
            }
    ...
    public static String prepareCharacterMaps(StyleElement element,
        ...
        while (st.hasMoreTokens()) {
            ...
            try {
                ...
                element.undeclaredNamespaceError(err.getPrefix(), "XTSE0280", "use-character-maps");
            }
        }
        existing = s + existing;
        return existing;
