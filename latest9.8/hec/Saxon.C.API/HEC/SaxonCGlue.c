...
void setDllname(){
	...
	if(env!= NULL) {
		...
		snprintf(resources_dir, rDir_len + 42 + 1,  "C:\\Program Files\\Saxonica\\SaxonHEC1.1.3", tempResources_dir);
		snprintf(dllname, name_len+42+1, "%s%s", "C:\\Program Files\\Saxonica\\SaxonHEC1.1.3", tempDllname);
#endif
