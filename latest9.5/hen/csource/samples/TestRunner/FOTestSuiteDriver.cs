...
namespace TestRunner
{
    ...
    public class FOTestSuiteDriver : TestDriver
    {
        ...
        public static void main(string[] args)
        {
            ...
            {
                System.Console.WriteLine("java com.saxonica.testdriver.FOTestSuiteDriver testsuiteDir catalog [-o:resultsdir] [-s:testSetName]" +
        ...
        public class ModuleResolver /*extends StandardModuleURIResolver*/ {
