...
public class StreamWriterToReceiver implements XMLStreamWriter {
    ...
    public StreamWriterToReceiver(Receiver receiver) {
        ...
        this.inScopeNamespaces = new NamespaceReducer();
        this.inScopeNamespaces.setUnderlyingReceiver(receiver);
        this.inScopeNamespaces.setPipelineConfiguration(pipe);
    ...
    public void writeStartElement(String prefix, String localName, String namespaceURI) throws XMLStreamException {
        ...
        try {
            if (namespaceURI != null && !isValidURI(namespaceURI)) {
            ...
            inStartTag = true;
            depth++;
            int nc = namePool.allocate(prefix, namespaceURI, localName);
            receiver.startElement(nc, StandardNames.XS_ANY_TYPE, 0, 0);
            inStartTag = true;
     ...
     */
    private String inventPrefix(String uri) throws XMLStreamException {
...
//        }
    ...
    public void writeAttribute(String prefix, String namespaceURI, String localName, String value)
        ...
        try {
            int nc = namePool.allocate(prefix, namespaceURI, localName);
            receiver.attribute(nc, StandardNames.XS_UNTYPED_ATOMIC, value, -1, 0);
        }
        catch (XPathException err) {
            throw new XMLStreamException(err);
        }
    ...
    private void outputNamespaceDeclaration(String prefix, String namespaceURI) throws XMLStreamException {
        try {
            ...
            int nsCode = namePool.allocateNamespaceCode(prefix, namespaceURI);
    ...
    public void writeProcessingInstruction(String target, String data) throws XMLStreamException {
        ...
        try {
            if (isChecking) {
                ...
                if (data != null && !isValidChars(data)) {
