    ...
    */
    ...
    public ConversionResult convertPrimitive(BuiltInAtomicType requiredType, boolean validate, ConversionRules rules) {
        ...
        case StandardNames.XS_POSITIVE_INTEGER:
            ConversionResult iv = convertPrimitive(BuiltInAtomicType.INTEGER, validate, rules);
        ...
        case StandardNames.XS_PRECISION_DECIMAL:
            return new PrecisionDecimalValue((double)value);
...
//    }
    ...
    */
    ...
    public NumericValue round(int scale) {
        ...
        try {
            return (FloatValue)
                    new DoubleValue((double)value).round(scale).convertPrimitive(BuiltInAtomicType.FLOAT, true, null).asAtomic();
