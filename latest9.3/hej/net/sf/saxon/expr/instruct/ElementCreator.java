...
public abstract class ElementCreator extends ParentNodeConstructor {
    ...
    protected EventIterator iterateEvents(XPathContext context, NodeInfo copiedNode) throws XPathException {
        ...
        start.setNameCode(getNameCode(context, copiedNode));
    ...
    throws XPathException {
        ...
        try {
            ...
            if (elemOut.getSystemId() == null) {
                elemOut.setSystemId(getNewBaseURI(c2, copiedNode));
            }
            ...
            outputNamespaceNodes(c2, elemOut, nameCode, copiedNode);
    ...
    protected final void processLeft(Stack<XPathContext> contextStack, Stack state, NodeInfo copiedNode) throws XPathException {
        ...
        try {
            ...
            outputNamespaceNodes(context, elemOut, nameCode, copiedNode);
        ...
        try {
            ...
            if (!preservingTypes) {
                ...
                if (ini.getSystemId() == null) {
                    ini.setSystemId(getNewBaseURI(c2, copiedNode));
                }
                if (validator == ini) {
            ...
            outputNamespaceNodes(c2, ini, nameCode, null);
