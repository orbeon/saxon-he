...
public class ForEach extends Instruction implements ContextMappingFunction {
    ...
    public ForEach(Expression select, Expression action, boolean containsTailCall, int threads) {
        this.select = select;
        this.action = action;
    ...
    */
    ...
    public Expression optimize(ExpressionVisitor visitor, ItemType contextItemType) throws XPathException {
        ...
        if (threads > 0) {
            return visitor.getConfiguration().getOptimizer().generateMultithreadedInstruction(this);
        }
        return this;
    }
