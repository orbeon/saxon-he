...
public abstract class NumericPromoter extends UnaryExpression {
    ...
    public SequenceIterator iterate(final XPathContext context) throws XPathException {
        ...
        ItemMappingFunction promoter = new ItemMappingFunction() {
            public Item mapItem(Item item) throws XPathException {
                return promote(((AtomicValue)item), rules);
            }
        };
    ...
    */
    ...
    public Item evaluateItem(XPathContext context) throws XPathException {
        ...
        return promote(((AtomicValue)item), context.getConfiguration().getConversionRules());
    }
    ...
    protected abstract AtomicValue promote(AtomicValue value, ConversionRules rules) throws XPathException;
