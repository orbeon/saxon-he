        ...
        if (u1 != u2) {
            ...
            if (u1) {
                ...
                if (a2 instanceof NumericValue) {
                    a1 = a1.convert(BuiltInAtomicType.DOUBLE, true, rules).asAtomic();
                } else {
                    a1 = a1.convert(a2.getPrimitiveType(), true, rules).asAtomic();
                }
            } else {
                // a2 is untyped atomic
                if (a1 instanceof NumericValue) {
                    a2 = a2.convert(BuiltInAtomicType.DOUBLE, true, rules).asAtomic();
                } else {
                    a2 = a2.convert(a1.getPrimitiveType(), true, rules).asAtomic();
                }
            }
