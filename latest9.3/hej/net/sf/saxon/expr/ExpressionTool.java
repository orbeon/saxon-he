 ...
 * Token.EOF, but may for example be a right curly brace
     ...
     * @param compileWithTracing true if diagnostic tracing during expression parsing is required @return an object of type Expression    @throws XPathException if the expression contains a static error
     */
    ...
    public static Expression make(String expression, StaticContext env,
                                  ...
                                  boolean compileWithTracing) throws XPathException {
...
//            return false;
    ...
    private static int outwardsAxes = (1<<Axis.CHILD) | (1<<Axis.DESCENDANT) | (1<<Axis.DESCENDANT_OR_SELF) |
