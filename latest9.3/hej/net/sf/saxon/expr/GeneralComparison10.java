    ...
    */
    ...
    private static boolean compare(AtomicValue a0,
        ...
        if (t0.equals(BuiltInAtomicType.STRING) || t1.equals(BuiltInAtomicType.STRING) ||
            ...
            StringValue s0 = (StringValue)a0.convert(BuiltInAtomicType.STRING, true, rules).asAtomic();
            StringValue s1 = (StringValue)a1.convert(BuiltInAtomicType.STRING, true, rules).asAtomic();
        ...
        if (t0.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a0 = a0.convert(t1, true, rules).asAtomic();
        }

        if (t1.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a1 = a1.convert(t0, true, rules).asAtomic();
        }
