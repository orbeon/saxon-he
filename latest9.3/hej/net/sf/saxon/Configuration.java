...
public class Configuration implements Serializable, SourceResolver, NotationSet {
    ...
    private ConversionRules conversionRules = null;
     ...
     * @return false for Saxon-HE, since the method is used to check for functionality that is not available in Saxon-HE
     * @since 9.2. Semantics changed in 9.3.
     */
    ...
    public void setRetainDTDAttributeTypes(boolean useTypes) throws TransformerFactoryConfigurationError {
        if (useTypes && !isLicensedFeature(LicenseFeature.SCHEMA_VALIDATION)) {
            throw new TransformerFactoryConfigurationError(
                    "Retaining DTD attribute types requires Saxon Enterprise Edition");
        }
    ...
    */
    ...
    public Object getConfigurationProperty(String name) {
        if (name.equals(FeatureKeys.ALLOW_EXTERNAL_FUNCTIONS)) {
            ...
            return Boolean.valueOf(isMultiThreading());    
            ...
            return Boolean.valueOf(isLazyConstructionMode());
            ...
            return Boolean.valueOf(defaultParseOptions.isAddCommentsAfterValidationErrors());
    ...
    public static class LicenseFeature {
        ...
        public static final int XOM_MODEL = 8;
        public static final int JDOM_MODEL = 16;
        public static final int DOM4J_MODEL = 32;
        public static final int PROFESSIONAL_EDITION = 64;
    }
