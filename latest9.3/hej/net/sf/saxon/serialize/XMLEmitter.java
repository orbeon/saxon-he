    ...
    */
    ...
    public void writeDeclaration() throws XPathException {
        ...
        try {
            ...
            s = outputProperties.getProperty(SaxonOutputKeys.LINE_LENGTH);
            if (s!=null) {
                try {
                    lineLength = Integer.parseInt(Whitespace.trim(s));
                } catch (NumberFormatException err) {
                    lineLength = 80;
                }
            }
    ...
    */
    ...
    public void namespace(int namespaceCode, int properties) throws XPathException {
        try {
            ...
            String sep = " ";
            if (indenting && (totalAttributeLength + len) > lineLength && totalAttributeLength != 0) {
