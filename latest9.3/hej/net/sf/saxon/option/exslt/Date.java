...
public final class Date {
    ...
    public static String add(XPathContext context, final String datetimeIn, final String durationIn) throws XPathException {
        ...
        YearMonthDurationValue v1m =
                (YearMonthDurationValue)v1.convertPrimitive(BuiltInAtomicType.YEAR_MONTH_DURATION, false, rules);
        DayTimeDurationValue v1s =
                (DayTimeDurationValue)v1.convertPrimitive(BuiltInAtomicType.DAY_TIME_DURATION, false, rules);
    ...
    private static DurationValue addDurationValues(DurationValue dv0, DurationValue dv1, XPathContext context) {
        ...
        YearMonthDurationValue dv0m =
                (YearMonthDurationValue)((DurationValue)dv0).convertPrimitive(BuiltInAtomicType.YEAR_MONTH_DURATION, false, rules);
        DayTimeDurationValue dv0s =
                (DayTimeDurationValue)((DurationValue)dv0).convertPrimitive(BuiltInAtomicType.DAY_TIME_DURATION, false, rules);
        YearMonthDurationValue dv1m =
                (YearMonthDurationValue)((DurationValue)dv1).convertPrimitive(BuiltInAtomicType.YEAR_MONTH_DURATION, false, rules);
        DayTimeDurationValue dv1s =
                (DayTimeDurationValue)((DurationValue)dv1).convertPrimitive(BuiltInAtomicType.DAY_TIME_DURATION, false, rules);
    ...
    public static String difference(XPathContext context, final String dateLeftIn, final String dateRightIn) throws XPathException {
        ...
        if (s0 < s1) {
            v1 = (CalendarValue)v1.convert(v0.getPrimitiveType(), false, rules);
        } else if (s1 < s0) {
            v0 = (CalendarValue)v0.convert(v1.getPrimitiveType(), false, rules);
        }
