...
public final class Navigator {
    ...
    public static NodeInfo getOutermostElement(DocumentInfo doc) {
        return (NodeInfo)doc.iterateAxis(Axis.CHILD, NodeKindTest.ELEMENT).next();
    }
...
//        }
     ...
     *                        as defined in {@link CopyOptions}
    ...
    public static void copy(NodeInfo node,
        ...
        switch (node.getNodeKind()) {
            ...
            case Type.ELEMENT:
                {
                    int annotation = ((copyOptions & CopyOptions.TYPE_ANNOTATIONS) != 0 ?
                            node.getTypeAnnotation() :
                            StandardNames.XS_UNTYPED);
                    out.startElement(node.getNameCode(), annotation, 0, 0);
            ...
            case Type.ATTRIBUTE:
                {
                    ...
                    out.attribute(node.getNameCode(), annotation, node.getStringValueCS(), 0, 0);
                    return;
                }
            case Type.TEXT:
                {
