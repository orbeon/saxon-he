...
public abstract class StandardFunction {
    ...
    */
    ...
    static {
        ...
        e = register("data#0", Data.class, 0, 0, 0, BuiltInAtomicType.ANY_ATOMIC,
        ...
        e = register("partial-apply", PartialApply.class, 0, 2, 3, AnyFunctionType.getInstance(),
                StaticProperty.ALLOWS_ONE, XPATH30);
        ...
        e = register("unparsed-text-lines", UnparsedText.class, UnparsedText.UNPARSED_TEXT_LINES, 1, 2,
