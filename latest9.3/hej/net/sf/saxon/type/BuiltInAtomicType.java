...
public class BuiltInAtomicType implements AtomicType, Serializable {
    ...
    public static BuiltInAtomicType PRECISION_DECIMAL = makeAtomicType(StandardNames.XS_PRECISION_DECIMAL, NUMERIC, true);
    ...
    public ValidationFailure validateContent(CharSequence value, NamespaceResolver nsResolver,
        ...
        NameChecker nameChecker = rules.getNameChecker();
        if (isNamespaceSensitive()) {
            ...
            try {
                ...
                if (uri == null) {
                    return new ValidationFailure("Namespace prefix " + Err.wrap(parts[0]) +
            ...
            ConversionResult v = StringValue.convertStringToBuiltInType(value, this, rules);
            if (v instanceof ValidationFailure) {
                return (ValidationFailure)v;
            }
        }
        return null;
    }
    ...
    public Value atomize(NodeInfo node) throws XPathException {
        ...
        return StringValue.convertStringToBuiltInType(stringValue, this, config.getConversionRules()).asAtomic();
    }
    ...
    public SequenceIterator getTypedValue(CharSequence value, NamespaceResolver resolver, ConversionRules rules)
            ...
            try {
                ...
                return SingletonIterator.makeIterator(
                        fingerprint == StandardNames.XS_QNAME ?
                                ...
                                new NotationValue(parts[0], uri, parts[1], nameChecker));
            } catch (QNameException err) {
        ...
        AtomicValue val = StringValue.convertStringToBuiltInType(value, this, rules).asAtomic();
        ...
        switch (fingerprint) {
            ...
            case StandardNames.XS_ENTITY:
                return StringValue.validate(
                        this, primValue.getStringValueCS(), rules.getNameChecker());
            default:
