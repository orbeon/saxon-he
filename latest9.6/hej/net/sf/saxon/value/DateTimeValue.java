...
public final class DateTimeValue extends CalendarValue implements Comparable {
    ...
    /*@NotNull*/
    public DateTimeValue normalize(/*@Nullable*/ XPathContext cc) throws NoDynamicContextException {
        if (hasTimezone()) {
            return adjustTimezone(0);
        } else {
            if (cc == null || cc.getImplicitTimezone() == CalendarValue.NO_TIMEZONE) {
    ...
    /*@NotNull*/
    public ComparisonKey getComparisonKey(/*@NotNull*/ XPathContext context) throws NoDynamicContextException {
...
//
    ...
    public AtomicValue getComponent(int component) throws XPathException {
        switch (component) {
            ...
            case AccessorFn.WHOLE_SECONDS: //(internal use only)
                return Int64Value.makeIntegerValue(second);
            case AccessorFn.MICROSECONDS:
                // internal use only
                return new Int64Value(microsecond);
            case AccessorFn.TIMEZONE:
                if (hasTimezone()) {
