...
public abstract class StandardFunction {
    ...
    static {
        ...
        register("analyze-string", AnalyzeStringFn.class, 0, 2, 3, NodeKindTest.ELEMENT,
        ...
        register("available-environment-variables", AvailableEnvironmentVariables.class, 0, 0, 0, BuiltInAtomicType.STRING,
                STAR, XPATH30 | USE_WHEN, 0);
        ...
        register("day-from-date", AccessorFn.class, (AccessorFn.DAY << 16) + StandardNames.XS_DATE, 1, 1, BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE, OPT, EMPTY);

        register("day-from-dateTime", AccessorFn.class, (AccessorFn.DAY << 16) + StandardNames.XS_DATE_TIME, 1, 1, BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("days-from-duration", AccessorFn.class, (AccessorFn.DAY << 16) + StandardNames.XS_DURATION, 1, 1, BuiltInAtomicType.INTEGER, OPT, CORE, 0)
        ...
        register("environment-variable", EnvironmentVariable.class, 0, 1, 1, BuiltInAtomicType.STRING,
                OPT, XPATH30 | USE_WHEN, 0)
        ...
        register("format-integer", FormatInteger.class, 0, 2, 3, AnyItemType.getInstance(), ONE, XPATH30, 0)
        ...
        register("head", HeadFn.class, 0, 1, 1, AnyItemType.getInstance(),
                OPT, XPATH30, 0)
                .arg(0, AnyItemType.getInstance(), STAR | TRA, null);

        register("hours-from-dateTime", AccessorFn.class, (AccessorFn.HOURS << 16) + StandardNames.XS_DATE_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("hours-from-duration", AccessorFn.class, (AccessorFn.HOURS << 16) + StandardNames.XS_DURATION, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DURATION, OPT, EMPTY);

        register("hours-from-time", AccessorFn.class, (AccessorFn.HOURS << 16) + StandardNames.XS_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.TIME, OPT, EMPTY);
        ...
        register("innermost", Innermost.class, 0, 1, 1, AnyNodeTest.getInstance(),
                        STAR, XPATH30, 0)
                        .arg(0, AnyNodeTest.getInstance(), STAR | NAV, null);

        register("insert-before", InsertBefore.class, 0, 3, 3, Type.ITEM_TYPE, STAR, CORE, 0)
        ...
        register("local-name-from-QName", AccessorFn.class, (AccessorFn.LOCALNAME << 16) + StandardNames.XS_QNAME, 1, 1,
        ...
        register("minutes-from-dateTime", AccessorFn.class, (AccessorFn.MINUTES << 16) + StandardNames.XS_DATE_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("minutes-from-duration", AccessorFn.class, (AccessorFn.MINUTES << 16) + StandardNames.XS_DURATION, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DURATION, OPT, EMPTY);

        register("minutes-from-time", AccessorFn.class, (AccessorFn.MINUTES << 16) + StandardNames.XS_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.TIME, OPT, EMPTY);

        register("month-from-date", AccessorFn.class, (AccessorFn.MONTH << 16) + StandardNames.XS_DATE, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE, OPT, EMPTY);

        register("month-from-dateTime", AccessorFn.class, (AccessorFn.MONTH << 16) + StandardNames.XS_DATE_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("months-from-duration", AccessorFn.class, (AccessorFn.MONTH << 16) + StandardNames.XS_DURATION, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DURATION, OPT, EMPTY);
        ...
        register("outermost", Outermost.class, 0, 1, 1, AnyNodeTest.getInstance(), STAR, XPATH30, 0)
                .arg(0, AnyNodeTest.getInstance(), STAR | TRA, null);

        register("parse-xml", ParseXml.class, 0, 1, 1, NodeKindTest.DOCUMENT, ONE, XPATH30, 0)
                .arg(0, BuiltInAtomicType.STRING, ONE, null);
        ...
        register("prefix-from-QName", AccessorFn.class, (AccessorFn.PREFIX << 16) + StandardNames.XS_QNAME, 1, 1, BuiltInAtomicType.NCNAME, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.QNAME, OPT, EMPTY);
        ...
        register("seconds-from-dateTime", AccessorFn.class, (AccessorFn.SECONDS << 16) + StandardNames.XS_DATE_TIME, 1, 1, BuiltInAtomicType.DECIMAL, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("seconds-from-duration", AccessorFn.class, (AccessorFn.SECONDS << 16) + StandardNames.XS_DURATION, 1, 1, BuiltInAtomicType.DECIMAL, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DURATION, OPT, EMPTY);

        register("seconds-from-time", AccessorFn.class, (AccessorFn.SECONDS << 16) + StandardNames.XS_TIME, 1, 1, BuiltInAtomicType.DECIMAL, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.TIME, OPT, EMPTY);

        register("serialize", Serialize.class, 0, 1, 2, BuiltInAtomicType.STRING, ONE, XPATH30, 0)
        ...
        register("tail", TailFn.class, 0, 1, 1, AnyItemType.getInstance(), STAR, XPATH30, 0)
                .arg(0, AnyItemType.getInstance(), STAR | TRA, null);

        register("timezone-from-date", AccessorFn.class, (AccessorFn.TIMEZONE << 16) + StandardNames.XS_DATE, 1, 1, BuiltInAtomicType.DAY_TIME_DURATION, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE, OPT, EMPTY);

        register("timezone-from-dateTime", AccessorFn.class, (AccessorFn.TIMEZONE << 16) + StandardNames.XS_DATE_TIME, 1, 1,
                BuiltInAtomicType.DAY_TIME_DURATION, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("timezone-from-time", AccessorFn.class, (AccessorFn.TIMEZONE << 16) + StandardNames.XS_TIME, 1, 1,
                BuiltInAtomicType.DAY_TIME_DURATION, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.TIME, OPT, EMPTY);
...
//                    UNIT, CORE)
        ...
        register("unparsed-text-lines", UnparsedTextLines.class, 0, 1, 2, BuiltInAtomicType.STRING, STAR, XPATH30, BASE)
                .arg(0, BuiltInAtomicType.STRING, OPT, null)
                .arg(1, BuiltInAtomicType.STRING, ONE, null);

        register("uri-collection", UriCollection.class, 0, 0, 1, BuiltInAtomicType.ANY_URI, STAR, XPATH30, 0)
                .arg(0, BuiltInAtomicType.STRING, OPT, null);

        register("year-from-date", AccessorFn.class, (AccessorFn.YEAR << 16) + StandardNames.XS_DATE, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE, OPT, EMPTY);

        register("year-from-dateTime", AccessorFn.class, (AccessorFn.YEAR << 16) + StandardNames.XS_DATE_TIME, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DATE_TIME, OPT, EMPTY);

        register("years-from-duration", AccessorFn.class, (AccessorFn.YEAR << 16) + StandardNames.XS_DURATION, 1, 1,
                BuiltInAtomicType.INTEGER, OPT, CORE, 0)
                .arg(0, BuiltInAtomicType.DURATION, OPT, EMPTY);
    ...
    public static class Entry implements java.io.Serializable {
        ...
        public Entry arg(int a, ItemType type, int options, /*@Nullable*/ Sequence resultIfEmpty) {
            ...
            OperandUsage syntacticContext = OperandUsage.NAVIGATION;
            if ((options & ABS) != 0) {
                syntacticContext = OperandUsage.ABSORPTION;
            } else if ((options & TRA) != 0) {
                syntacticContext = OperandUsage.TRANSMISSION;
            } else if ((options & INS) != 0) {
                syntacticContext = OperandUsage.INSPECTION;
