...
public class ExecutableFunctionLibrary implements FunctionLibrary {
     ...
     * @param container    the container for the returned expression
...
//#ifdefined HOF
     ...
     * @param container     the container for the returned function item
    ...
    public FunctionItem getFunctionItem(SymbolicName functionName, StaticContext staticContext, Container container) throws XPathException {
        final UserFunction uf = functions.get(functionName);
        if (uf == null) {
            return null;
        } else {
            return new com.saxonica.functions.hof.CallableFunctionItem(uf);
        }
    }
//#endif
