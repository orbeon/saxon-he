...
public class StaticQueryContext {
    ...
    private DecimalValue languageVersion = DecimalValue.THREE;
...
//        executable.setSchemaAware(c.executable.isSchemaAware());
     ...
     *
     * @param version The XQuery language version. Must be "1.0" or "3.0".
    ...
    public XQueryExpression compileQuery(/*@NotNull*/ String query) throws XPathException {
        ...
        Executable executable = makeExecutable();
    ...
    public void declareGlobalVariable(
        ...
        pd.setAllowXPath30(getLanguageVersion().equals(DecimalValue.THREE));
        pd.setHostLanguage(Configuration.XQUERY);
        pd.setSchemaAware(isSchemaAware());
        pd.setLocationMap(makeExecutable().getLocationMap());
    ...
    public void declareCollation(String name, Comparator comparator) {
        getConfiguration().registerCollation(name, new SimpleCollation(comparator));
    }
