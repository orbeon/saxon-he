...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9, 6, 0, 1};
    private static final String VERSION = "9.6.0.1";
    private static final String BUILD = "101022"; //mmddhh
    private static final String RELEASE_DATE = "2014-10-02";
