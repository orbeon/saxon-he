...
public class ManualIterator implements FocusIterator, UnfailingIterator,
    ...
    public ManualIterator(Item value) {
        this.item = value;
        this.position = 1;
        this.lastPositionFinder = new LastPositionFinder<Item>() {
    ...
    /*@NotNull*/
    public ManualIterator getAnother() {
        ManualIterator m2 = new ManualIterator(item, position);
        m2.lastPositionFinder = lastPositionFinder;
        return m2;
    }
