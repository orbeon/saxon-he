...
public class SQLConnect extends ExtensionInstruction {
    ...
    Expression user;
    Expression password;
    Expression autoCommit = Literal.makeEmptySequence(this);
    ...
    public void prepareAttributes() throws XPathException {
        ...
        if (userAtt == null) {
            user = new StringLiteral(StringValue.EMPTY_STRING, this);
        } else {
        ...
        if (pwdAtt == null) {
            password = new StringLiteral(StringValue.EMPTY_STRING, this);
        } else {
