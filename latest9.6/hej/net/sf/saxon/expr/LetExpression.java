...
//        }
    ...
    public Expression optimize(ExpressionVisitor visitor, ContextItemStaticInfo contextItemType) throws XPathException {
        ...
        if (action instanceof VariableReference &&
                ...
                !ExpressionTool.changesXsltContext(sequence)) {
...
//            }
        ...
        if (refCount == 1 && ExpressionTool.changesXsltContext(sequence)) {
            refCount = 5;
        }
    ...
    public Sequence eval(XPathContext context) throws XPathException {
        ...
        Sequence result = ExpressionTool.evaluate(sequence, evaluationMode, context, refCount);
