...
public class GlobalVariable extends ComponentBody implements Binding, Container, net.sf.saxon.query.Declaration, InstructionInfo {
...
//        }
    ...
    public void lookForCycles(Stack<Container> referees, XQueryFunctionLibrary globalFunctionLibrary) throws XPathException {
        if (referees.contains(this)) {
            ...
            if (getVariableQName().equals(StandardNames.SAXON_CONTEXT_ITEM)) {
            ...
            for (int i = s; i < referees.size() - 1; i++) {
                ...
                if (referees.get(i + 1) instanceof GlobalVariable) {
                    ...
                    if (next.getVariableQName().equals(StandardNames.SAXON_CONTEXT_ITEM)) {
            ...
            if (getHostLanguage() == Configuration.XSLT) {
                errorCode = "XTDE0640";
            } else if (getPackageData().isAllowXPath30()) {
                errorCode = "XQDY0054";
            } else {
                errorCode = "XQST0054";
            }
    ...
    public Sequence getSelectValue(XPathContext context, Component target) throws XPathException {
        if (select == null) {
            ...
            try {
                ...
                ManualIterator mi = new ManualIterator(controller.getContextForGlobalVariables());
