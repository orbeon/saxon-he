...
public class CallTemplate extends Instruction implements ITemplateCall, ComponentInvocation {
     ...
     *
     * @return the symbolic name of the target template
     */

    public SymbolicName getSymbolicName() {
        return template.getSymbolicName();
    }
    ...
    public Expression typeCheck(ExpressionVisitor visitor, ContextItemStaticInfo contextInfo) throws XPathException {
        ...
        if (template.getBody() != null) {
            ...
            for (int p = 0; p < actualParams.length; p++) {
                ...
                LocalParam lp = template.getLocalParam(wp.getVariableQName());
                if (lp != null) {
    ...
    public Iterable<Operand> operands() {
        ...
        WithParam.gatherOperands(actualParams, list);
        WithParam.gatherOperands(tunnelParams, list);
        return list;
    }
    ...
    public void process(XPathContext context) throws XPathException {
        ...
        if (target.getVisibility() == Visibility.ABSTRACT) {
            ...
            XPathException err = new XPathException("Cannot call an abstract template", "XTSE3080");
            err.setLocator(this);
            throw err;
        }
        t = (Template) target.getProcedure();
    ...
    public TailCall processLeavingTail(XPathContext context) throws XPathException {
        if (useTailRecursion) {
            ...
            if (targetComponent.getVisibility() == Visibility.ABSTRACT) {
                // TODO: review whether this should be a static error
                throw new XPathException("Cannot call an abstract template", "XTSE3080");
            }
            Template target = (Template) targetComponent.getProcedure();
    ...
    public static class CallTemplatePackage implements TailCall {
        ...
        public TailCall processLeavingTail() throws XPathException {
            ...
            c2.setCurrentComponent(target.getDeclaringComponent());
...
//#ifdefined STREAM
    ...
    protected StreamingAdjunct getStreamingAdjunct() {
        return new CallTemplateAdjunct();
    }
//#endif
}
