...
public abstract class StandardNames {
	...
	*/
    ...
    public static final int DFLT = 128*0;       //   0
    public static final int XSL = 128*1;        // 128
    public static final int SAXON = 128*2;      // 256
    public static final int XML = 128*3;        // 384
    public static final int XS = 128*4;         // 512
    public static final int XDT = 128*5;        // 640
    public static final int XSI = 128*6;        // 768
    ...
    public static final int SAXON_VALIDATE_TYPE = SAXON + 8;
    public static final int SAXON_WHILE = SAXON + 9;
    ...
    public static final int XDT_UNTYPED                 = XDT + 1;    // 641
    public static final int XDT_UNTYPED_ATOMIC          = XDT + 2;    // 642
    public static final int XDT_ANY_ATOMIC_TYPE         = XDT + 3;    // 643
    public static final int XDT_YEAR_MONTH_DURATION     = XDT + 4;    // 644
    public static final int XDT_DAY_TIME_DURATION       = XDT + 5;    // 645
    public static final int XDT_NUMERIC                 = XDT + 6;    // 646
    ...
    private static void bindXDTName(int constant, String localName) {
        // TODO: remove the XDT namespace
        localNames[constant] = localName;
        Integer value = new Integer(constant);
        lookup.put('{' + NamespaceConstant.XDT + '}' + localName, value);
        lookup.put('{' + NamespaceConstant.SCHEMA + '}' + localName, value);
    }
	...
	static {
        ...
        bindSaxonName(SAXON_VALIDATE_TYPE,  "validate-type");
        ...
        bindXDTName(XDT_NUMERIC, "_numeric_");
