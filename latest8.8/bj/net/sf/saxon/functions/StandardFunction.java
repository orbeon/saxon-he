...
public abstract class StandardFunction {
    ...
    */
    ...
    static {
        ...
        e = register("days-from-duration", Component.class, (Component.DAY<<16) + Type.DURATION, 1, 1, Type.INTEGER_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
                    arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("document-uri", NamePart.class, NamePart.DOCUMENT_URI, 1, 1, Type.ANY_URI_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.NODE_TYPE, StaticProperty.ALLOWS_ZERO_OR_MORE);
        ...
        e = register("encode-for-uri", EscapeURI.class, EscapeURI.ENCODE_FOR_URI, 1, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);

        e = register("escape-html-uri", EscapeURI.class, EscapeURI.HTML_URI, 1, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
...
//        e = register("escape-uri", EscapeURI.class, EscapeURI.ESCAPE, 2, 2, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
//            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
//            arg(e, 1, Type.BOOLEAN_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("hours-from-duration", Component.class, (Component.HOURS<<16) + Type.DURATION, 1, 1, Type.INTEGER_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
                    arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("iri-to-uri", EscapeURI.class, EscapeURI.IRI_TO_URI, 1, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("minutes-from-duration", Component.class, (Component.MINUTES<<16) + Type.DURATION, 1, 1, Type.INTEGER_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("months-from-duration", Component.class, (Component.MONTH<<16) + Type.DURATION, 1, 1, Type.INTEGER_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("nilled", Nilled.class, 0, 1, 1, Type.BOOLEAN_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.NODE_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);

        e = register("node-name", NamePart.class, NamePart.NODE_NAME, 1, 1, Type.QNAME_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.NODE_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);

        e = register("not", BooleanFn.class, BooleanFn.NOT, 1, 1, Type.BOOLEAN_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.ITEM_TYPE, StaticProperty.ALLOWS_ZERO_OR_MORE);

            register("normalize-space", NormalizeSpace.class, 0, 0, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("normalize-unicode", NormalizeUnicode.class, 0, 1, 2, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("prefix-from-QName", Component.class, (Component.PREFIX<<16) + Type.QNAME, 1, 1, Type.NCNAME_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.QNAME_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("seconds-from-duration", Component.class, (Component.SECONDS<<16) + Type.DURATION, 1, 1, Type.DECIMAL_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
                    arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
        ...
        e = register("string", StringFn.class, 0, 0, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            ...
            register("string-length", StringLength.class, 0, 0, 1, Type.INTEGER_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("type-available", Available.class, Available.TYPE_AVAILABLE, 1, 1, Type.BOOLEAN_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("unparsed-text", UnparsedText.class, UnparsedText.UNPARSED_TEXT, 1, 2, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);

        e = register("unparsed-text-available", UnparsedText.class, UnparsedText.UNPARSED_TEXT_AVAILABLE, 1, 2, Type.BOOLEAN_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 0, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
            arg(e, 1, Type.STRING_TYPE, StaticProperty.EXACTLY_ONE);
        ...
        e = register("years-from-duration", Component.class, (Component.YEAR<<16) + Type.DURATION, 1, 1, Type.INTEGER_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
            arg(e, 0, Type.DURATION_TYPE, StaticProperty.ALLOWS_ZERO_OR_ONE);
