 ...
 * <ul>
 * <li><i>Sorting multiple arrays in sync</i></li>
 * <li><i>Sorting by multiple sorting criteria</i> (primary, secondary, tertiary,
 * ...)</li>
 * </ul>
 * <h4>Sorting multiple arrays in sync</h4>
 * <p>Assume we have three arrays X, Y and Z. We want to sort all three arrays by
 * X (or some arbitrary comparison function). For example, we have
 * <tt>X=[3, 2, 1], Y=[3.0, 2.0, 1.0], Z=[6.0, 7.0, 8.0]</tt>. The output should
 * be <tt>X=[1, 2, 3], Y=[1.0, 2.0, 3.0], Z=[8.0, 7.0, 6.0]</tt>. </p>
 * <p>How can we achieve this? Here are several alternatives. We could ... </p>
 * <ol>
 ...
 * copy in the right order back from the temporary into X. Same for Y and Z. </li>
 ...
 * </ol>
 * <p>Alternatives 1 and 2 involve quite a lot of copying and allocate significant amounts
 * of temporary memory. Alternative 3 involves more swapping, more polymorphic message dispatches,
 * no copying and does not need any temporary memory.</p>
 ...
 * object that knows how to swap the data of these indexes.</p>
 * <p>The following snippet shows how to solve the problem.</p>
 * <pre>
 * final int[] x;
 * final double[] y;
 * final double[] z;
 ...
 * by multiple columns. It preserves the relative position of equal elements.</p>
 *
...
public class GenericSorter extends Object {
     ...
     * <tt>b</tt> in the range).
     * <p>The sorting algorithm is a tuned quicksort,
     ...
     * quicksorts to degrade to quadratic performance.</p>
     *
