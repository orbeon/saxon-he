...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9, 9, 1, 6};
    private static final String VERSION = "9.9.1.6";
    private static final String BUILD = "120613"; //mmddhh
    private static final String RELEASE_DATE = "2019-12-06";
      ...
      //#if PE!=true && EE!=true && DOTNET != true && SAXONC == true
       ...
       //#else
        ...
        //#if PE==true && DOTNET != true && SAXONC == true
                platform = new com.saxonica.config.NativePlatformPE();
        //#endif
