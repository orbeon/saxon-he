...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9, 9, 1, 3};
    private static final String VERSION = "9.9.1.3";
    private static final String BUILD = "051512"; //mmddhh
    private static final String RELEASE_DATE = "2019-05-15";
