...
void setDllname(){
	...
	if(env!= NULL) {
		...
		snprintf(resources_dir, rDir_len + 42 + 1,  "C:\\Program Files\\Saxonica\\SaxonEEC1.2.0", tempResources_dir);
		snprintf(dllname, name_len+42+1, "%s%s", "C:\\Program Files\\Saxonica\\SaxonEEC1.2.0", tempDllname);
#endif
