...
public class GeneralComparison10 extends BinaryExpression implements CallableExpression {
   ...
   /**
    ...
    public SequenceIterator call(SequenceIterator[] arguments, XPathContext context) throws XPathException {
        BooleanValue b = BooleanValue.get(effectiveBooleanValue(arguments[0], arguments[1], context));
        return SingletonIterator.makeIterator(b);
    }    
    ...
    */
    ...
    private static boolean compare(AtomicValue a0,
        ...
        if (t0.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a0 = StringConverter.getStringConverter(t1, rules).convert(a0).asAtomic();
        }

        if (t1.equals(BuiltInAtomicType.UNTYPED_ATOMIC)) {
            a1 = StringConverter.getStringConverter(t0, rules).convert(a1).asAtomic();
        }
