...
//        }
    ...
    public Expression optimize(ExpressionVisitor visitor, ExpressionVisitor.ContextItemType contextItemType) throws XPathException {
        ...
        if (refCount == 1 && ExpressionTool.dependsOnFocus(sequence)) {
            ...
            if (container instanceof Template && ((Template)container).isStreamable() && sequence instanceof DocumentInstr) {
                refCount = 5;
            }
        }
    ...
    public ValueRepresentation eval(XPathContext context) throws XPathException {
