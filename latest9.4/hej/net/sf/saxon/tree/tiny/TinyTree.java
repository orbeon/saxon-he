...
public final class TinyTree {
    ...
    /*@Nullable*/
    protected Value<? extends AtomicValue>[] typedValueArray = null;
    ...
    private void ensureNodeCapacity(short kind) {
        if (nodeKind.length < numberOfNodes+1) {
            ...
            if (typedValueArray != null) {
                ...
                Value<AtomicValue>[] typedValueArray2 = new Value[k];
    ...
    private void ensureAttributeCapacity() {
        if (attParent.length < numberOfAttributes+1) {
            ...
            if (attTypedValue != null) {
                @SuppressWarnings({"unchecked"})
                Value<? extends AtomicValue>[] attTypedValue2 = new Value[k];
...
//        }
    ...
    */
    ...
    /*@Nullable*/ public Value<? extends AtomicValue> getTypedValueOfElement(/*@NotNull*/ TinyElementImpl element) throws XPathException {
        ...
        if (typedValueArray == null || typedValueArray[nodeNr] == null) {
            ...
            if (annotation == StandardNames.XS_UNTYPED || annotation == StandardNames.XS_UNTYPED_ATOMIC ||
                ...
                if (stype == null) {
                    ...
                    Value<? extends AtomicValue> value = stype.atomize(element);
    ...
    /*@Nullable*/ public Value getTypedValueOfElement(int nodeNr) throws XPathException {
        if (typedValueArray == null || typedValueArray[nodeNr] == null) {
            int annotation = getTypeAnnotation(nodeNr);
    ...
    public Value<? extends AtomicValue> getTypedValueOfAttribute(/*@Nullable*/ TinyAttributeImpl att, int nodeNr) throws XPathException {
        if (attTypeCode == null) {
        ...
        if (attTypedValue == null || attTypedValue[nodeNr] == null) {
            ...
            if (annotation == StandardNames.XS_UNTYPED_ATOMIC) {
                ...
                if (stype == null) {
                    ...
                    Value<? extends AtomicValue> value = stype.atomize(att);
                    if (allowTypedValueCache) {
                        if (attTypedValue == null) {
                            //noinspection unchecked
