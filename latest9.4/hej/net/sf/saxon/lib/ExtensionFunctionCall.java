...
public abstract class ExtensionFunctionCall implements Serializable {
   ...
   /**
    ...
    public abstract SequenceIterator<? extends Item> call(
            SequenceIterator<? extends Item>[] arguments, XPathContext context) throws XPathException;
    ...
    public boolean effectiveBooleanValue(SequenceIterator<? extends Item>[] arguments, XPathContext context) throws XPathException {
