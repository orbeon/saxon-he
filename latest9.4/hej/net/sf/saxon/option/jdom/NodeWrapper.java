...
public class
        NodeWrapper implements NodeInfo, VirtualNode, SiblingCountingNode {

    protected Object node;          // the JDOM node to which this XPath node is mapped; or a List of
                                    // adjacent text nodes
    protected short nodeKind;
    /*@Nullable*/ private NodeWrapper parent;     // null means unknown
    ...
    */
    ...
    public String getAttributeValue(int fingerprint) {
        if (nodeKind==Type.ELEMENT) {
            ...
            return getAttributeValue(uri, local);
        }
        return null;
    }
