...
public class Doc extends SystemFunction implements CallableExpression {
    ...
    public boolean equals(Object o) {
        return (o instanceof Doc) && super.equals(o)
                && (expressionBaseURI == null || expressionBaseURI.equals(((Doc)o).expressionBaseURI))
    ...
    public SequenceIterator call(SequenceIterator[] arguments, XPathContext context) throws XPathException {
        AtomicValue hrefVal = (AtomicValue)arguments[0].next();
        if (hrefVal==null) {
            return null;
        }
        String href = hrefVal.getStringValue();
