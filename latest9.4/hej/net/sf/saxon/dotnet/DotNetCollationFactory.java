...
public abstract class DotNetCollationFactory {
     ...
     * @throws net.sf.saxon.trans.XPathException if it is not possible to create a collation with the
     * requested properties
     */

    /*@Nullable*/ public static StringCollator makeCollation(Configuration config, Properties props) throws XPathException {
        ...
        if (rulesAtt!=null && stringCollator==null) {
            try {
                stringCollator = new SimpleCollation(new RuleBasedCollator(rulesAtt));
