...
public class QueryParser extends ExpressionParser {
    ...
    /*@NotNull*/ public static String XQUERY10 = "1.0";
    /*@NotNull*/ public static String XQUERY30 = "3.0";
    ...
    /*@NotNull*/ public XQueryExpression makeXQueryExpression(
...
//            }
    ...
    /*@NotNull*/ private Expression parseQuery(String queryString,
                                  int start,
                                  int terminator,
...
//        ep.close();
     ...
     * @return a Locator
     */
    /*@NotNull*/ private ExpressionLocation makeLocator() {
     ...
     * @return a Locator
     */
    /*@NotNull*/ private ExpressionLocation makeLocator(int offset) {
    ...
    protected int parseAnnotations() throws XPathException {
        grumble("Function and variable annotations are not allowed in XQuery 1.0");
        return 0;
    }
...
//        }
     ...
     * @param options derived from any %-annotations present in XQuery 3.0
     * @throws XPathException if a static error is found
     */

    private void parseVariableDeclaration(int options) throws XPathException {
        ...
        var.setPrivate((options & FUNCTION_IS_PRIVATE) != 0);
        nextToken();
        expect(Token.DOLLAR);
     ...
     * @param functionOptions function annotations such as updating, deterministic etc
     *
    ...
    /*@Nullable*/ public Expression setDefaultValue(String exp) {
        try {
    ...
    /*@NotNull*/ protected LetExpression makeLetExpression() {
    ...
    /*@Nullable*/ public static Expression makeStringJoin(Expression exp, /*@NotNull*/ StaticContext env) {
     ...
     * @throws XPathException if parsing fails
     */
    /*@NotNull*/ private List parseSortDefinition() throws XPathException {
    ...
    /*@NotNull*/ private List<SequenceType> parseSequenceTypeList() throws XPathException {
    ...
    /*@NotNull*/ private Expression parseTypeswitchReturnClause(StructuredQName varQName, LetExpression outerLet)
            throws XPathException {
        Expression action;
//        t.treatCurrentAsOperator();
//        expect(Token.RETURN);
...
//            }
    ...
    /*@NotNull*/ private static StructuredQName parseExtendedQName(/*@NotNull*/ String in, /*@NotNull*/ NameChecker checker) throws XPathException {
        if (in.length() < 4) {
    ...
    /*@NotNull*/ private Expression parseDocumentConstructor(int offset) throws XPathException {
        nextToken();
        Expression content = parseExpression();
        expect(Token.RCURLY);
        lookAhead();  // must be done manually after an RCURLY
    ...
    /*@NotNull*/ private Expression parseComputedElementConstructor(int offset) throws XPathException {
        nextToken();
    ...
    /*@NotNull*/ private Expression parseComputedAttributeConstructor(int offset) throws XPathException {
        nextToken();
        Expression name = parseExpression();
        expect(Token.RCURLY);
        lookAhead();  // must be done manually after an RCURLY
    ...
    private Expression parseNamedAttributeConstructor(int offset) throws XPathException {
        ...
        if (t.currentTokenValue.startsWith("xmlns:")) {
            grumble("Cannot create a namespace declaration using an attribute constructor", "XPST0081");
        }
    ...
    /*@NotNull*/ protected Expression parseNamespaceConstructor(int offset) throws XPathException {
        grumble("Namespace node constructors are not allowed in XQuery 1.0");
        return new ErrorExpression();
    }

    /*@NotNull*/ protected Expression parseNamedNamespaceConstructor(int offset) throws XPathException {
        grumble("Namespace node constructors are not allowed in XQuery 1.0");
        return new ErrorExpression();
    }
...
//    }
    ...
    /*@NotNull*/ private Expression parsePseudoXML(boolean allowEndTag) throws XPathException {
        try {
            Expression exp;
...
//            }
    ...
    /*@Nullable*/ private Expression makeAttributeContent(/*@NotNull*/ String avt,
                                            int start,
                                            char terminator,
   ...
   /**
    ...
    /*@Nullable*/ private Expression parsePIConstructor() throws XPathException {
        try {
    ...
    /*@Nullable*/ private Expression parseCommentConstructor() throws XPathException {
        try {
            char c = t.nextChar();
            // XML-like comment
            expectChar(c, '-');
    ...
    public static Expression stringify(Expression exp, boolean noNodeIfEmpty, Configuration config) throws XPathException {
        ...
        exp = new AtomicSequenceConverter(exp, BuiltInAtomicType.STRING, true);
        ((AtomicSequenceConverter)exp).allocateConverter(config);
    ...
    /*@NotNull*/ private FastStringBuffer unescape(/*@NotNull*/ String token) throws XPathException {
    ...
    /*@Nullable*/ private String readEntityReference() throws XPathException {
        try {
    ...
    /*@Nullable*/ private String analyzeEntityReference(/*@NotNull*/ String entity) throws XPathException {
        if ("lt".equals(entity)) {
            return "<";
    ...
    /*@Nullable*/ private String parseCharacterReference(/*@NotNull*/ String entity) throws XPathException {
        int value = 0;
    ...
    /*@NotNull*/ protected String normalizeEQName(/*@NotNull*/ String s) throws XPathException {
    ...
    /*@NotNull*/ protected String getLanguage() {
        return "XQuery";
    }
