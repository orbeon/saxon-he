...
//    }
    ...
    /*@NotNull*/ public List evaluate(/*@NotNull*/ DynamicQueryContext env) throws XPathException {
        if (isUpdating) {
    ...
    /*@NotNull*/ public Set runUpdate(/*@NotNull*/ DynamicQueryContext dynamicEnv) throws XPathException {
        if (!isUpdating) {
...
//            return rewrittenTrees;
    ...
    /*@NotNull*/ private XPathContextMajor initialContext(/*@NotNull*/ DynamicQueryContext dynamicEnv, /*@NotNull*/ Controller controller) throws XPathException {
