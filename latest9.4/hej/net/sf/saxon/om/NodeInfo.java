...
public interface NodeInfo extends Source, Item<NodeInfo>, ValueRepresentation<NodeInfo> {
    ...
    */
     ...
     * atomic values.
     * @since 8.5
     * @throws net.sf.saxon.trans.XPathException if the node has no typed value, for example if
