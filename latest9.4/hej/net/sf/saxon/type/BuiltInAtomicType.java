...
public class BuiltInAtomicType implements AtomicType, Serializable {
    ...
    /*@NotNull*/ public final SequenceIterator getTypedValue(/*@NotNull*/ NodeInfo node)
    ...
    /*@NotNull*/ public SequenceIterator getTypedValue(CharSequence value, NamespaceResolver resolver, /*@NotNull*/ ConversionRules rules)
        ...
        AtomicValue val = converter.convertString(value).asAtomic();
    ...
    /*@Nullable*/ public ValidationFailure validate(/*@NotNull*/ AtomicValue primValue, CharSequence lexicalValue, ConversionRules rules) {
        switch (fingerprint) {
            ...
            case StandardNames.XS_ENTITY:
                StringConverter sc = StringConverter.getStringConverter(this, rules);
