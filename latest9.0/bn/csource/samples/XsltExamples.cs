...
public class XsltExamples {
    ...
    public static void Main(String[] argv) {
        ...
        if (test == "all" || test == "UseTemplatesObj") {
            Console.WriteLine("\n\n==== UseTemplatesObj ====");
        ...
        if (test == "all" || test == "XMLFilterChain") {
            Console.WriteLine("\n\n==== XMLFilterChain ====");
        ...
        if (test == "all" || test == "SaxonToSaxonNonRoot") {
            Console.WriteLine("\n\n==== SaxonToSaxonNonRoot ====");
        ...
        if (test == "all" || test == "DOMtoDOM") {
            Console.WriteLine("\n\n==== DOMtoDOM (using wrapper) ====");
        ...
        if (test == "all" || test == "TransformerReuse") {
            Console.WriteLine("\n\n==== TransformerReuse ====");
        ...
        if (test == "all" || test == "OutputProperties") {
            Console.WriteLine("\n\n==== OutputProperties ====");
        ...
        if (test == "all" || test == "UseAssociated") {
            Console.WriteLine("\n\n==== UseAssociated ====");
        ...
        if (test == "all" || test == "DisplayingErrors") {
            Console.WriteLine("\n\n==== DisplayingErrors ====");
        ...
        if (test == "all" || test == "CapturingErrors") {
            Console.WriteLine("\n\n==== CapturingErrors ====");
        ...
        if (test == "all" || test == "UsingURIResolver") {
            Console.WriteLine("\n\n==== UsingURIResolver ====");
        ...
        if (test == "all" || test == "MultipleOutput") {
            Console.WriteLine("\n\n==== MultipleOutput ====");
        ...
        if (test == "all" || test == "UsingResultDocumentHandler") {
            Console.WriteLine("\n\n==== UsingResultDocumentHandler ====");
        ...
        if (test == "all" || test == "Extensibility") {
            Console.WriteLine("\n\n==== Extensibility ====");

            try {
                ExampleExtensibility(foo_xml);
            } catch (Exception ex) {
                handleException(ex);
            }
        }
