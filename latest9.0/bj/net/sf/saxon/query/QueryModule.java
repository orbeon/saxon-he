...
public class QueryModule implements StaticContext {
     ...
     * the stylesheet
     * @param start the StaticQueryContext where the search started
...
//        // namespace (we hope!)
//        for (int i=0; i<importers.size(); i++) {
//            QueryModule importer = (QueryModule)importers.get(i);
//            if (!start.importsNamespace(importer.getModuleNamespace())) {
//                return importer.getTopLevelModule(start);
//            }
//        }
//        return ((QueryModule)importers.get(0)).getTopLevelModule(start);
    }
    ...
    public void declareVariable(VariableDeclaration var) throws XPathException {
        ...
        final HashMap libVars = getTopLevelModule(this).libraryVariables;
...
//                 if (((ActiveNamespace)activeNamespaces.get(i)).prefix.length() == 0) {
//                     defaultElementNamespace = ((ActiveNamespace)activeNamespaces.get(i)).uri;
//                     return;
//                 }
//             }
//             String defaultNS = userQueryContext.getDefaultElementNamespace();
//             if ("".equals(defaultNS)) {
