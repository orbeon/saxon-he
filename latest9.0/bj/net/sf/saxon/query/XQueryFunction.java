...
//        return params;
     ...
     * @return the compiled UserFunction object
     * @throws XPathException if errors are found
     */

    public UserFunction compile() throws XPathException {
        ...
        try {
            ...
            if (compiledFunction == null) {
                ...
                body.setContainer(this);
                RoleLocator role =
                        new RoleLocator(RoleLocator.FUNCTION_RESULT, functionName, 0, staticContext.getNamePool());
...
//    }
     ...
     * @param pool the name pool (not used in this implementation)
     */
