...
//        if (decl != null) {
//            positionBinding = new PositionBinding(decl.getVariableQName());
//        }
    }
    ...
    /**
     * Set the action expression ("return ACTION")
        ...
        if (positionVariable==null &&
            ...
            if (count == 1 && s2 instanceof VariableReference && ((VariableReference)s2).getBinding() == this &&
                ...
                if ((newPath.getSpecialProperties() & StaticProperty.ORDERED_NODESET) != 0) {
                    ...
                    return visitor.optimize(visitor.typeCheck(visitor.simplify(newPath), contextItemType), contextItemType);
                }
            }
        }
            ...
            for (int t=list.size()-1; t>=0; t--) {
                ...
                if (term instanceof ValueComparison || term instanceof SingletonComparison) {
                    ...
                    if (positionVariable == null &&
                        ...
                        if (newSequence != null && !ExpressionTool.dependsOnVariable(newSequence, thisVar)) {
