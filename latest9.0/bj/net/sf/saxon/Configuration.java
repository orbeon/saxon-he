...
//    }
   ...
   *
    ...
    */
     ...
     * @param minutes the implicit timezone as an offset from UTC in minutes. Note that this
     * must be constant for a configuraton
     */
...
//    }
    ...
    public Source resolveSource(Source source, Configuration config) throws XPathException {
        ...
        if (source instanceof PullSource) return source;
        return null;
    }
    ...
    */
    ...
    public void setConfigurationProperty(String name, Object value) {
        ...
        if (name.equals(FeatureKeys.ALLOW_EXTERNAL_FUNCTIONS)) {
        	...
        	setAllowExternalFunctions(((Boolean)value).booleanValue());
            ...
            if (!(value instanceof Boolean)) {
        		throw new IllegalArgumentException("PRE_EVALUATE_DOC_FUNCTION must be a boolean");
        	}
            preEvaluateDocFunction = ((Boolean)value).booleanValue();
        	...
        	setTiming(((Boolean)value).booleanValue());
        	...
        	setTraceExternalFunctions(((Boolean)value).booleanValue());

        } else if (name.equals(FeatureKeys.TRACE_OPTIMIZER_DECISIONS)) {
        	if (!(value instanceof Boolean)) {
        		throw new IllegalArgumentException("TRACE_OPTIMIZER_DECISIONS must be a boolean");
        	}
        	setOptimizerTracing(((Boolean)value).booleanValue());
        	...
        	if (!(value instanceof Boolean)) {
        		throw new IllegalArgumentException("USE_PI_DISABLE_OUTPUT_ESCAPING must be a boolean");
        	}
        	useDisableOutputEscaping = ((Boolean)value).booleanValue();
        	...
        	setValidationWarnings(((Boolean)value).booleanValue());

        } else if (name.equals(FeatureKeys.VERSION_WARNING)) {
             if (!(value instanceof Boolean)) {
                 throw new IllegalArgumentException("VERSION_WARNING must be a boolean");
             }
             setVersionWarning(((Boolean)value).booleanValue());

        } else if (name.equals(FeatureKeys.XINCLUDE)) {
            if (!(value instanceof Boolean)) {
                throw new IllegalArgumentException(
                        "XINCLUDE value must be a boolean");

            }
            setXIncludeAware(((Boolean)value).booleanValue());
