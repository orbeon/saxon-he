...
public class XPathExpressionImpl implements XPathExpression, SortKeyEvaluator {
    ...
    */
     ...
     * @deprecated since 9.0. This method relies on the context node being set, and it is
     * therefore not thread-safe. Use {@link #rawIterator(Item)} instead.
    */

    public SequenceIterator rawIterator() throws XPathException {
        return rawIterator(contextNode);
    }
