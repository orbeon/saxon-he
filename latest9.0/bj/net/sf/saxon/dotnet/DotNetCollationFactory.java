...
//        if (decompositionAtt!=null && stringCollator instanceof Collator) {
//            if (decompositionAtt.equals("none")) {
//                ((Collator)stringCollator).setDecomposition(Collator.NO_DECOMPOSITION);
//            } else if (decompositionAtt.equals("standard")) {
//                ((Collator)stringCollator).setDecomposition(Collator.CANONICAL_DECOMPOSITION);
//            } else if (decompositionAtt.equals("full")) {
//                ((Collator)stringCollator).setDecomposition(Collator.FULL_DECOMPOSITION);
//            } else {
