...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9,0,0,5};
    private static final String VERSION = "9.0.0.5";
    private static final String BUILD = "051214"; //mmddhh
    private static final String RELEASE_DATE = "2008-05-12";
