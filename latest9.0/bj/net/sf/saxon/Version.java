...
public final class Version {
    ...
    private static final int[] STRUCTURED_VERSION = {9,0,0,8};
    private static final String VERSION = "9.0.0.8";
    private static final String BUILD = "090114"; //mmddhh
    private static final String RELEASE_DATE = "2008-09-01";
