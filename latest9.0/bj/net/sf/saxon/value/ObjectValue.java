    ...
    */
    ...
    public Object convertToJava(Class target, XPathContext context) throws XPathException {
        ...
        if (target.isAssignableFrom(value.getClass())) {
            ...
            DoubleValue bval = (DoubleValue)convertPrimitive(BuiltInAtomicType.DOUBLE, true, context).asAtomic();
            return new Double(bval.getDoubleValue());
        } else if (target==float.class || target==Float.class) {
            DoubleValue bval = (DoubleValue)convertPrimitive(BuiltInAtomicType.FLOAT, true, context).asAtomic();
            return new Float(bval.getDoubleValue());
        } else if (target==long.class || target==Long.class) {
            Int64Value bval = (Int64Value)convertPrimitive(BuiltInAtomicType.INTEGER, true, context).asAtomic();
